...
ATLASLOOT_VERSION = "|cffFF8400AtlasLoot Hyjal 1.2";
...
function AtlasLootMinimapButton_OnEnter()
	...
	GameTooltip:SetText("AtlasLoot Hyjal");
...
AtlasLoot_DewDropDown_SubTables = {
	...
	["LowerBlackrock"] = {
		...
		--Added in 1.10 { BB["Mor Grayhoof"], "LBRSGrayhoof" },
	...
	["UpperBlackrock"] = {
		...
		--Added in 1.10 { BB["Lord Valthalak"], "UBRSValthalak" },
	...
	["MoltenCore"] = {
		...
		--Added in 1.4 { BB["Majordomo Executus"], "MCMajordomo" },
		{ BB["Ragnaros"], "MCRagnaros" },
		{ AL["Trash Mobs"], "MCTrashMobs" },
		--Added in 1.4 { AL["Random Boss Loot"], "MCRANDOMBOSSDROPS" },
	},
	["Naxxramas"] = {
	...
	["SMGraveyard"] = {
		...
		--Added in patch 1.11 { BB["Scorn"].." ("..AL["Scourge Invasion"]..")", "SMScorn" },
	...
	["SMCathedral"] = {
		--Added in patch 1.5 { BB["High Inquisitor Fairbanks"], "SMFairbanks" },
	...
	["ShadowfangKeep"] = {
		...
		--Added in patch 1.11 { BB["Sever"].." ("..AL["Scourge Invasion"]..")", "SFKSever" },
	...
	["Stratholme"] = {
		...
		--Added in 1.11 { BB["Atiesh"], "STRATAtiesh" },
		--Added in 1.11 { BB["Balzaphon"].." ("..AL["Scourge Invasion"]..")", "STRATBalzaphon" },
		...
		--Added in 1.10 { BB["Sothos"].." & "..BB["Jarien"], "STRATSothosJarien" },
	...
	["RazorfenDowns"] = {
		...
		--Added in patch 1.11 { BB["Lady Falther'ess"].." ("..AL["Scourge Invasion"]..")", "RFDLadyF" },
	...
	["ZulFarrak"] = {
		...
		--Added in patch 1.3 { BB["Witch Doctor Zum'rah"], "ZFWitchDoctorZumrah" },
		{ BB["Shadowpriest Sezz'ziz"], "ZFSezzziz" },
		--Added in patch 1.10 { AL["Dustwraith"].." ("..AL["Rare"]..")", "ZFDustwraith" },
	...
	["Factions"] = {
		...
		--Added in 1.9 { BF["Brood of Nozdormu"], "AQBroodRings" },
		--Added in 1.9 { BF["Cenarion Circle"], "Cenarion1" },
		--Added in 1.6 { BF["Darkmoon Faire"], "Darkmoon" },
		--Added in 1.5 { BF["Frostwolf Clan"], "Frostwolf1" },
		--Added in 1.5 { BF["Stormpike Guard"], "Stormpike1" },	
		...
		--Added in 1.7 { BF["Zandalar Tribe"], "Zandalar1" },
	},
	["BoEWorldEpics"] = {
	...
	["Pre60Sets"] = {	
		...
		--Added in 1.10 { BIS["Ironweave Battlesuit"], "IRONWEAVE" },	
		--Added in 1.7 { BIS["Primal Blessing"], "PrimalBlessing" },
		--Added in 1.11 { AL["Scourge Invasion"], "ScourgeInvasion" },
		{ BIS["Shard of the Gods"], "ShardOfGods" },
		{ BIS["Spider's Kiss"], "SpiderKiss" },
		--Added in 1.3 { BIS["Spirit of Eskhandar"], "SpiritofEskhandar" },
		{ BIS["The Gladiator"], "BLACKROCKD" },
		{ BIS["The Postmaster"], "SCARLET" },
		--Added in 1.7 { BIS["The Twin Blades of Hakkari"], "HakkariBlades" },
		--Added in 1.7 { AL["Zul'Gurub Rings"], "ZGRings" },
	},
	["WSGRewards"] = {
