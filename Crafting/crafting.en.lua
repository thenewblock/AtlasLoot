...
---------------
	...
	AlchemyArtisan1 = {
		...
		--Changed in 1.3 { "s17187", "inv_misc_stonetablet_05", "=q2=Transmute: Arcanite", "=ds=#sr# =so1=275 =so2=275 =so3=282 =so4=290" },
		{ "s17187", "inv_misc_stonetablet_05", "=q1=Transmute: Arcanite", "=ds=#sr# =so1=275 =so2=275 =so3=282 =so4=290" },
		--Changed in 1.3 { "s17559", "spell_fire_volcano", "=q2=Transmute: Air to Fire", "=ds=#sr# =so1=275 =so2=275 =so3=282 =so4=290" },
		{ "s17559", "spell_fire_volcano", "=q1=Transmute: Air to Fire", "=ds=#sr# =so1=275 =so2=275 =so3=282 =so4=290" },
		--Changed in 1.3 { "s17566", "spell_nature_abolishmagic", "=q2=Transmute: Earth to Life", "=ds=#sr# =so1=275 =so2=275 =so3=282 =so4=290" },
		{ "s17566", "spell_nature_abolishmagic", "=q1=Transmute: Earth to Life", "=ds=#sr# =so1=275 =so2=275 =so3=282 =so4=290" },
		--Changed in 1.3 { "s17561", "spell_nature_acid_01", "=q2=Transmute: Earth to Water", "=ds=#sr# =so1=275 =so2=275 =so3=282 =so4=290" },
		{ "s17561", "spell_nature_acid_01", "=q1=Transmute: Earth to Water", "=ds=#sr# =so1=275 =so2=275 =so3=282 =so4=290" },
		--Changed in 1.3 { "s17560", "spell_nature_strengthofearthtotem02", "=q2=Transmute: Fire to Earth", "=ds=#sr# =so1=275 =so2=275 =so3=282 =so4=290" },
		{ "s17560", "spell_nature_strengthofearthtotem02", "=q1=Transmute: Fire to Earth", "=ds=#sr# =so1=275 =so2=275 =so3=282 =so4=290" },
		--Changed in 1.3 { "s17565", "spell_nature_strengthofearthtotem02", "=q2=Transmute: Life to Earth", "=ds=#sr# =so1=275 =so2=275 =so3=282 =so4=290" },
		{ "s17565", "spell_nature_strengthofearthtotem02", "=q1=Transmute: Life to Earth", "=ds=#sr# =so1=275 =so2=275 =so3=282 =so4=290" },
		--Changed in 1.3 { "s17563", "spell_nature_acid_01", "=q2=Transmute: Undeath to Water", "=ds=#sr# =so1=275 =so2=275 =so3=282 =so4=290" },
		{ "s17563", "spell_nature_acid_01", "=q1=Transmute: Undeath to Water", "=ds=#sr# =so1=275 =so2=275 =so3=282 =so4=290" },
		--Changed in 1.3 { "s17562", "spell_nature_earthbind", "=q2=Transmute: Water to Air", "=ds=#sr# =so1=275 =so2=275 =so3=282 =so4=290" },
		{ "s17562", "spell_nature_earthbind", "=q1=Transmute: Water to Air", "=ds=#sr# =so1=275 =so2=275 =so3=282 =so4=290" },
		--Changed in 1.3 { "s17564", "spell_shadow_shadetruesight", "=q2=Transmute: Water to Undeath", "=ds=#sr# =so1=275 =so2=275 =so3=282 =so4=290" },
		{ "s17564", "spell_shadow_shadetruesight", "=q1=Transmute: Water to Undeath", "=ds=#sr# =so1=275 =so2=275 =so3=282 =so4=290" },
		{ "s17557", "inv_potion_40", "=q1=Elixir of Brute Force", "=ds=#sr# =so1=275 =so2=290 =so3=310 =so4=330" },
	};

	AlchemyArtisan2 = {
		--Added in 1.7 { "s24366", "inv_potion_83", "=q1=Greater Dreamless Sleep Potion", "=ds=#sr# =so1=275 =so2=290 =so3=310 =so4=330" },
		--Added in 1.7 { "s24365", "inv_potion_45", "=q1=Mageblood Potion", "=ds=#sr# =so1=275 =so2=290 =so3=310 =so4=330" },
		...
		--Added in 1.7 { "s24367", "inv_potion_07", "=q1=Living Action Potion", "=ds=#sr# =so1=285 =so2=300 =so3=320 =so4=340" },
		...
		--Added in 1.7 { "s24368", "inv_potion_80", "=q1=Major Troll's Blood Potion", "=ds=#sr# =so1=290 =so2=305 =so3=325 =so4=345" },
		{ "s17580", "inv_potion_76", "=q1=Major Mana Potion", "=ds=#sr# =so1=295 =so2=310 =so3=330 =so4=350" },
		--Added in 1.9 { "s25146", "spell_fire_fire", "=q1=Transmute: Elemental Fire", "=ds=#sr# =so1=300 =so2=301 =so3=305 =so4=310" },
		--Added in 1.4 { "s22732", "inv_potion_47", "=q1=Major Rejuvenation Potion", "=ds=#sr# =so1=300 =so2=310 =so3=320 =so4=330" },
		...
		--Added in 1.7 { "s24266", "inv_poison_mindnumbing", "=q3=Gurubashi Mojo Madness", "=ds=#sr# =so1=300 =so2=315 =so3=322 =so4=330" },
	};
...
----------------
	...
	EnchantingApprentice1 = {
		...
		--Changed in 1.8 { "e14293", "INV_Staff_02", "=q2=Lesser Magic Wand", "=ds=#sr# =so1=10 =so2=75 =so3=95 =so4=115" },
		{ "e14293", "INV_Staff_02", "=q1=Lesser Magic Wand", "=ds=#sr# =so1=10 =so2=75 =so3=95 =so4=115" },
		...
		--Added in 1.9 { "e25124", "INV_Poison_MindNumbing", "=q1=Minor Wizard Oil", "=ds=#sr# =so1=45 =so2=55 =so3=65 =so4=75" },
		...
		--Changed in 1.8 { "e14807", "INV_Staff_07", "=q2=Greater Magic Wand", "=ds=#sr# =so1=70 =so2=110 =so3=130 =so4=150" },
		{ "e14807", "INV_Staff_07", "=q1=Greater Magic Wand", "=ds=#sr# =so1=70 =so2=110 =so3=130 =so4=150" },
	};
	...
	EnchantingJourneyman1 = {
		...
		--Added in 1.7 { "e7793", "Spell_Holy_GreaterHeal", "=ds=Enchant 2H Weapon - Lesser Intellect", "=ds=#sr# =so1=100 =so2=130 =so3=150 =so4=170" },
		...
		--Added in 1.9 { "e25125", "INV_Potion_98", "=q1=Minor Mana Oil", "=ds=#sr# =so1=150 =so2=160 =so3=170 =so4=180" },
	};
	...
	EnchantingExpert1 = {
		...
		--Changed in 1.8 { "e14809", "INV_Staff_02", "=q2=Lesser Mystic Wand", "=ds=#sr# =so1=155 =so2=175 =so3=195 =so4=215" },
		{ "e14809", "INV_Staff_02", "=q1=Lesser Mystic Wand", "=ds=#sr# =so1=155 =so2=175 =so3=195 =so4=215" },
		...
		--Changed in 1.8 { "e14810", "INV_Wand_07", "=q2=Greater Mystic Wand", "=ds=#sr# =so1=175 =so2=195 =so3=215 =so4=235" },
		{ "e14810", "INV_Wand_07", "=q1=Greater Mystic Wand", "=ds=#sr# =so1=175 =so2=195 =so3=215 =so4=235" },
		...
		--Added in 1.9 { "e25126", "INV_Potion_103", "=q1=Lesser Wizard Oil", "=ds=#sr# =so1=200 =so2=210 =so3=220 =so4=230" },
	...
	EnchantingArtisan1 = {
		...
		--Added in 1.9 { "e25127", "INV_Potion_99", "=q1=Lesser Mana Oil", "=ds=#sr# =so1=250 =so2=260 =so3=270 =so4=280" },
		...
		--Added in 1.6 { "e20020", "Spell_Holy_GreaterHeal", "=ds=Enchant Boots - Greater Stamina", "=ds=#sr# =so1=260 =so2=280 =so3=300 =so4=320" },
		--Added in 1.6 { "e20014", "Spell_Holy_GreaterHeal", "=ds=Enchant Cloak - Greater Resistance", "=ds=#sr# =so1=265 =so2=285 =so3=305 =so4=325" },
		...
		--Added in 1.9 { "e25128", "INV_Potion_104", "=q1=Wizard Oil", "=ds=#sr# =so1=275 =so2=285 =so3=295 =so4=305" },
	...
	EnchantingArtisan2 = {
		--Added in 1.10 { "e27837", "Spell_Holy_GreaterHeal", "=ds=Enchant 2H Weapon - Agility", "=ds=#sr# =so1=290 =so2=310 =so3=330 =so4=350" },
		--Added in 1.6 { "e23801", "Spell_Holy_GreaterHeal", "=ds=Enchant Bracer - Mana Regeneration", "=ds=#sr# =so1=290 =so2=310 =so3=330 =so4=350" },
		{ "e20028", "Spell_Holy_GreaterHeal", "=ds=Enchant Chest - Major Mana", "=ds=#sr# =so1=290 =so2=310 =so3=330 =so4=350" },
		--Added in 1.6 { "e23800", "Spell_Holy_GreaterHeal", "=ds=Enchant Weapon - Agility", "=ds=#sr# =so1=290 =so2=310 =so3=330 =so4=350" },
		--Added in 1.6 { "e23799", "Spell_Holy_GreaterHeal", "=ds=Enchant Weapon - Strength", "=ds=#sr# =so1=290 =so2=310 =so3=330 =so4=350" },
		...
		--Added in 1.9 { "e25130", "INV_Potion_100", "=q1=Brilliant Mana Oil", "=ds=#sr# =so1=300 =so2=310 =so3=320 =so4=330" },
		--Aded in 1.9 { "e25129", "INV_Potion_105", "=q1=Brilliant Wizard Oil", "=ds=#sr# =so1=300 =so2=310 =so3=320 =so4=330" },
		...
		--Added in 1.6 { "e23802", "Spell_Holy_GreaterHeal", "=ds=Enchant Bracer - Healing Power", "=ds=#sr# =so1=300 =so2=320 =so3=340 =so4=360" },
		...
		--Added in 1.9 { "e25086", "Spell_Holy_GreaterHeal", "=ds=Enchant Cloak - Dodge", "=ds=#sr# =so1=300 =so2=320 =so3=340 =so4=360" },
		--Added in 1.9 { "e25081", "Spell_Holy_GreaterHeal", "=ds=Enchant Cloak - Greater Fire Resistance", "=ds=#sr# =so1=300 =so2=320 =so3=340 =so4=360" },
		--Added in 1.9 { "e25082", "Spell_Holy_GreaterHeal", "=ds=Enchant Cloak - Greater Nature Resistance", "=ds=#sr# =so1=300 =so2=320 =so3=340 =so4=360" },
		--Added in 1.9 { "e25083", "Spell_Holy_GreaterHeal", "=ds=Enchant Cloak - Stealth", "=ds=#sr# =so1=300 =so2=320 =so3=340 =so4=360" },
		--Added in 1.9 { "e25084", "Spell_Holy_GreaterHeal", "=ds=Enchant Cloak - Subtlety", "=ds=#sr# =so1=300 =so2=320 =so3=340 =so4=360" },
		--Added in 1.9 { "e25078", "Spell_Holy_GreaterHeal", "=ds=Enchant Gloves - Fire Power", "=ds=#sr# =so1=300 =so2=320 =so3=340 =so4=360" },
		--Added in 1.9 { "e25074", "Spell_Holy_GreaterHeal", "=ds=Enchant Gloves - Frost Power", "=ds=#sr# =so1=300 =so2=320 =so3=340 =so4=360" },
		--Added in 1.9 { "e25079", "Spell_Holy_GreaterHeal", "=ds=Enchant Gloves - Healing Power", "=ds=#sr# =so1=300 =so2=320 =so3=340 =so4=360" },
		--Added in 1.9 { "e25073", "Spell_Holy_GreaterHeal", "=ds=Enchant Gloves - Shadow Power", "=ds=#sr# =so1=300 =so2=320 =so3=340 =so4=360" },
		--Added in 1.9 { "e25080", "Spell_Holy_GreaterHeal", "=ds=Enchant Gloves - Superior Agility", "=ds=#sr# =so1=300 =so2=320 =so3=340 =so4=360" },
		--Added in 1.9 { "e25072", "Spell_Holy_GreaterHeal", "=ds=Enchant Gloves - Threat", "=ds=#sr# =so1=300 =so2=320 =so3=340 =so4=360" },
	...
	EnchantingArtisan3 = {
		--Added in 1.3 { "e22750", "Spell_Holy_GreaterHeal", "=ds=Enchant Weapon - Healing Power", "=ds=#sr# =so1=300 =so2=320 =so3=340 =so4=360" },
		--Added in 1.7 { "e20032", "Spell_Holy_GreaterHeal", "=ds=Enchant Weapon - Lifestealing", "=ds=#sr# =so1=300 =so2=320 =so3=340 =so4=360" },
		--Added in 1.6 { "e23804", "Spell_Holy_GreaterHeal", "=ds=Enchant Weapon - Mighty Intellect", "=ds=#sr# =so1=300 =so2=320 =so3=340 =so4=360" },
		--Added in 1.6 { "e23803", "Spell_Holy_GreaterHeal", "=ds=Enchant Weapon - Mighty Spirit", "=ds=#sr# =so1=300 =so2=320 =so3=340 =so4=360" },
		--Added in 1.3 { "e22749", "Spell_Holy_GreaterHeal", "=ds=Enchant Weapon - Spell Power", "=ds=#sr# =so1=300 =so2=320 =so3=340 =so4=360" },
		-- Move in 1.3 { "e20031", "Spell_Holy_GreaterHeal", "=ds=Enchant Weapon - Superior Striking", "=ds=#sr# =so1=300 =so2=320 =so3=340 =so4=360" },
	};
...
---------------------
	...
	SmithingArtisan1 = {
		...
		--Added in 1.11 { "s16647", "inv_belt_01", "=q2=Imperial Plate Belt", "=ds=#sr# =so1=265 =so2=285 =so3=295 =so4=305" },
		--Added in 1.11 { "s16646", "inv_shoulder_02", "=q2=Imperial Plate Shoulders", "=ds=#sr# =so1=265 =so2=285 =so3=295 =so4=305" },
		{ "s15293", "inv_chest_chain_16", "=q2=Dark Iron Mail", "=ds=#sr# =so1=270 =so2=290 =so3=300 =so4=310" },
		--Added in 1.11 { "s16649", "inv_bracer_19", "=q2=Imperial Plate Bracers", "=ds=#sr# =so1=270 =so2=290 =so3=300 =so4=310" },
	...
	SmithingArtisan2 = {
		...
		--Added in 1.6 { "s23632", "inv_belt_11", "=q3=Girdle of the Dawn", "=ds=#sr# =so1=290 =so2=310 =so3=320 =so4=330" },
		--Added in 1.6 { "s23628", "inv_belt_16", "=q3=Heavy Timbermaw Belt", "=ds=#sr# =so1=290 =so2=310 =so3=320 =so4=330" },
		{ "s16984", "inv_hammer_06", "=q2=Volcanic Hammer", "=ds=#sr# =so1=290 =so2=315 =so3=327 =so4=340" },
		--Added in 1.11 { "s16657", "inv_boots_plate_01", "=q2=Imperial Plate Boots", "=ds=#sr# =so1=295 =so2=315 =so3=325 =so4=335" },
		--Added in 1.11 { "s16658", "inv_helmet_22", "=q2=Imperial Plate Helm", "=ds=#sr# =so1=295 =so2=315 =so3=325 =so4=335" },
		{ "s16659", "inv_crown_01", "=q2=Radiant Circlet", "=ds=#sr# =so1=295 =so2=315 =so3=325 =so4=335" },
		--Added in 1.4 { "s22757", "inv_stone_02", "=q2=Elemental Sharpening Stone", "=ds=#sr# =so1=300 =so2=300 =so3=310 =so4=320" },
		--Added in 1.11 { "s16663", "inv_chest_plate10", "=q2=Imperial Plate Chest", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.11 { "s16730", "inv_pants_04", "=q2=Imperial Plate Leggings", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		...
		--Added in 1.7 { "s24136", "inv_chest_chain_14", "=q3=Bloodsoul Breastplate", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.7 { "s24138", "inv_gauntlets_31", "=q3=Bloodsoul Gauntlets", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.7 { "s24137", "inv_shoulder_15", "=q3=Bloodsoul Shoulders", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.8 { "s24914", "inv_chest_plate06", "=q3=Darkrune Breastplate", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.8 { "s24912", "inv_gauntlets_27", "=q3=Darkrune Gauntlets", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.8 { "s24913", "inv_helmet_10", "=q3=Darkrune Helm", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.7 { "s24139", "inv_chest_plate08", "=q3=Darksoul Breastplate", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.7 { "s24140", "inv_pants_plate_21", "=q3=Darksoul Leggings", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.7 { "s24141", "inv_shoulder_01", "=q3=Darksoul Shoulders", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.6 { "s23633", "inv_gauntlets_29", "=q3=Gloves of the Dawn", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.10 { "s27585", "inv_belt_16", "=q3=Heavy Obsidian Belt", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
	};

	SmithingArtisan3 = {
		--Added in 1.6 { "s23629", "inv_boots_chain_10", "=q3=Heavy Timbermaw Boots", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.11 { "s28463", "inv_belt_21", "=q3=Ironvine Belt", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.11 { "s28461", "inv_chest_plate07", "=q3=Ironvine Breastplate", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.11 { "s28462", "inv_gauntlets_29", "=q3=Ironvine Gloves", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
	    --Added in 1.10	{ "s27588", "inv_belt_16", "=q3=Light Obsidian Belt", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.10 { "s27589", "inv_gauntlets_31", "=q4=Black Grasp of the Destroyer", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.11 { "s28244", "inv_bracer_07", "=q4=Icebane Bracers", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.11 { "s28242", "inv_chest_chain_11", "=q4=Icebane Breastplate", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.11 { "s28243", "inv_gauntlets_28", "=q4=Icebane Gauntlets", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.10 { "s27586", "inv_shield_22", "=q4=Jagged Obsidian Shield", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.10 { "s27590", "inv_chest_chain_17", "=q4=Obsidian Mail Tunic", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.10 { "s27587", "inv_chest_chain_17", "=q4=Thick Obsidian Breastplate", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.4 { "s21161", "inv_hammer_unique_sulfuras", "=q4=Sulfuron Hammer", "=ds=#sr# =so1=300 =so2=325 =so3=337 =so4=350" },
	};
	...
	Armorsmith1 = {
		...
		-- Added in 1.4 { "s16745", "inv_chest_plate10", "=q3=Enchanted Thorium Breastplate", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		-- Added in 1.4 { "s16742", "inv_helmet_02", "=q3=Enchanted Thorium Helm", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		-- Added in 1.4 { "s16744", "inv_pants_04", "=q3=Enchanted Thorium Leggings", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		...
		-- Added in 1.7 { "s24399", "inv_boots_chain_08", "=q4=Dark Iron Boots", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		-- Added in 1.6 { "s23637", "inv_gauntlets_22", "=q4=Dark Iron Gauntlets", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		-- Added in 1.6 { "s23636", "inv_helmet_22", "=q4=Dark Iron Helm", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		...
		-- Added in 1.10 { "s27829", "inv_pants_04", "=q4=Titanic Leggings", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
	};
	...
	Weaponsmith1 = {
		...
		--Added in 1.6 { "s23638", "inv_weapon_shortblade_12", "=q4=Black Amnesty", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.6 { "s23639", "inv_spear_08", "=q4=Blackfury", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
	};
	...
	--Added in 1.6 { "s23653", "inv_axe_12", "=q4=Nightfall", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
	};
	...
	--Added in 1.6 { "s23650", "inv_hammer_19", "=q4=Ebon Hand", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
	--Added in 1.10 { "s27830", "inv_hammer_08", "=q4=Persuader", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
	};
	...
	--Added in 1.6 { "s23652", "inv_sword_39", "=q4=Blackguard", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
	--Added in 1.10 { "s27832", "inv_sword_51", "=q4=Sageblade", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
	};
...
--------------------
	...
	LeatherJourneyman1 = {
		...
		--Changed in 1.8 { "s6702", "inv_belt_02", "=q2=Murloc Scale Belt", "=ds=#sr# =so1=90 =so2=120 =so3=135 =so4=150" },
		{ "s6702", "inv_belt_02", "=q1=Murloc Scale Belt", "=ds=#sr# =so1=90 =so2=120 =so3=135 =so4=150" },
	    ...
	    --Added in 1.8 { "s24940", "inv_chest_cloth_45", "=q2=Black Whelp Tunic", "=ds=#sr# =so1=100 =so2=125 =so3=137 =so4=150" },
	...
	LeatherJourneyman2 = {
		...
		--Added in 1.4 { "s23190", "inv_misc_throwingball_01", "=q1=Heavy Leather Ball", "=ds=#sr# =so1=150 =so2=150 =so3=155 =so4=160" },
	...
	LeatherExpert1 = {
	    ...
	    --Added in 1.5 { "s23399", "inv_bracer_15", "=q3=Barbaric Bracers", "=ds=#sr# =so1=155 =so2=175 =so3=185 =so4=195" },
		...
		--Added in 1.3 { "s22711", "inv_gauntlets_32", "=q3=Shadowskin Gloves", "=ds=#sr# =so1=200 =so2=210 =so3=220 =so4=230" },
	...
	LeatherArtisan2 = {
		--Added in 1.6 { "s23705", "inv_boots_cloth_08", "=q3=Dawn Treaders", "=ds=#sr# =so1=290 =so2=310 =so3=320 =so4=330" },
		--Added in 1.6 { "s23703", "inv_belt_09", "=q3=Might of the Timbermaw", "=ds=#sr# =so1=290 =so2=310 =so3=320 =so4=330" },
		...
		--Added in 1.7 { "s24124", "inv_chest_leather_07", "=q3=Blood Tiger Breastplate", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.7 { "s24125", "inv_shoulder_23", "=q3=Blood Tiger Shoulders", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.11 { "s28474", "inv_belt_17", "=q3=Bramblewood Belt", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.11 { "s28473", "inv_boots_cloth_04", "=q3=Bramblewood Boots", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.11 { "s28472", "inv_helmet_58", "=q3=Bramblewood Helm", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.4 { "s22727", "inv_misc_armorkit_05", "=q3=Core Armor Kit", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.3 { "s22921", "inv_belt_26", "=q3=Girdle of Insight", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.6 { "s23706", "inv_shoulder_26", "=q3=Golden Mantle of the Dawn", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.3 { "s22922", "inv_boots_08", "=q3=Mongoose Boots", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.6 { "s19093", "inv_misc_cape_05", "=q3=Onyxia Scale Cloak", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.7 { "s24123", "inv_bracer_07", "=q3=Primal Batskin Bracers", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.7 { "s24122", "inv_gauntlets_31", "=q3=Primal Batskin Gloves", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.7 { "s24121", "inv_chest_leather_03", "=q3=Primal Batskin Jerkin", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.8 { "s24849", "inv_bracer_12", "=q3=Sandstalker Bracers", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.8 { "s24851", "inv_chest_plate07", "=q3=Sandstalker Breastplate", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.8 { "s24850", "inv_gauntlets_11", "=q3=Sandstalker Gauntlets", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.8 { "s24846", "inv_bracer_05", "=q3=Spitfire Bracers", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.8 { "s24848", "inv_chest_leather_02", "=q3=Spitfire Breastplate", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.8 { "s24847", "inv_gauntlets_11", "=q3=Spitfire Gauntlets", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.3 { "s22923", "inv_bracer_05", "=q3=Swift Flight Bracers", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.6 { "s23704", "inv_gauntlets_26", "=q3=Timbermaw Brawlers", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
	};

	LeatherArtisan3 = {
		--Added in 1.11 { "s28224", "inv_bracer_07", "=q4=Icy Scale Bracers", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.11 { "s28222", "inv_chest_plate09", "=q4=Icy Scale Breastplate", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.11 { "s28223", "inv_gauntlets_28", "=q4=Icy Scale Gauntlets", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.6 { "s23707", "inv_belt_32", "=q4=Lava Belt", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.11 { "s28221", "inv_bracer_07", "=q4=Polar Bracers", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.11 { "s28220", "inv_gauntlets_06", "=q4=Polar Gloves", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.11 { "s28219", "inv_chest_cloth_08", "=q4=Polar Tunic", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
	};
	...
	Dragonscale1 = {
		...
		--Added in 1.3 { "s22926", "inv_misc_cape_02", "=q4=Chromatic Cloak", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.6 { "s23708", "inv_gauntlets_22", "=q4=Chromatic Gauntlets", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.8 { "s24703", "inv_chest_plate08", "=q4=Dreamscale Breastplate", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
	};
	...
	Elemental1 = {
		...
		--Added in 1.10 { "s26279", "inv_gauntlets_05", "=q3=Stormshroud Gloves", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.6 { "s23710", "inv_belt_13", "=q4=Molten Belt", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		{ "s20854", "inv_helmet_08", "=q4=Molten Helm", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.3 { "s22928", "inv_misc_cape_20", "=q4=Shifting Cloak", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
	};
	...
	Tribal1 = {
		...
		--Added in 1.6 { "s23709", "inv_belt_24", "=q4=Corehound Belt", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.3 { "s22927", "inv_misc_cape_01", "=q4=Hide of the Wild", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
	};
...
---------------
	...
	TailoringExpert2 = {
		...
		--changed in 1.3 { "s12059", "inv_misc_cape_11", "=q2=White Bandit Mask", "=ds=#sr# =so1=215 =so2=220 =so3=225 =so4=230" },
		{ "s12059", "inv_misc_cape_11", "=q1=White Bandit Mask", "=ds=#sr# =so1=215 =so2=220 =so3=225 =so4=230" },
		...
		--Added in 1.10 { "s27658", "inv_misc_bag_enchantedmageweave", "=q2=Enchanted Mageweave Pouch", "=ds=#sr# =so1=225 =so2=240 =so3=255 =so4=270" },
	...
	TailoringArtisan1 = {
	   ...
	   --Added in 1.9 { "s26403", "inv_chest_cloth_56", "=q1=Festival Dress", "=ds=#sr# =so1=250 =so2=265 =so3=280 =so4=295" },
		--Added in 1.9 { "s26407", "inv_chest_cloth_55", "=q1=Festive Red Pant Suit", "=ds=#sr# =so1=250 =so2=265 =so3=280 =so4=295" },
		{ "s12093", "inv_shirt_black_01", "=q1=Tuxedo Jacket", "=ds=#sr# =so1=250 =so2=265 =so3=280 =so4=295" },
		--Changed in 1.11 { "s12092", "inv_crown_01", "=q3=Dreamweave Circlet", "=ds=#sr# =so1=250 =so2=265 =so3=280 =so4=295" },
		{ "s12092", "inv_crown_01", "=q2=Dreamweave Circlet", "=ds=#sr# =so1=250 =so2=265 =so3=280 =so4=295" },
	...
	TailoringArtisan2 = {
		--Added in 1.9 { "s26085", "inv_misc_bag_soulbag", "=q2=Soul Pouch", "=ds=#sr# =so1=260 =so2=275 =so3=290 =so4=305" },
		...
		--Added in 1.3 { "s22813", "inv_chest_chain_14", "=q2=Gordok Ogre Suit", "=ds=#sr# =so1=275 =so2=285 =so3=290 =so4=295" },
		{ "s18420", "inv_misc_cape_11", "=q2=Brightcloth Cloak", "=ds=#sr# =so1=275 =so2=290 =so3=305 =so4=320" },
		--Added in 1.10 { "s27724", "inv_misc_bag_cenarionherbbag", "=q2=Cenarion Herb Bag", "=ds=#sr# =so1=275 =so2=290 =so3=305 =so4=320" },
		{ "s18418", "inv_misc_cape_18", "=q2=Cindercloth Cloak", "=ds=#sr# =so1=275 =so2=290 =so3=305 =so4=320" },
		--Added in 1.10 { "s27659", "inv_misc_bag_enchantedrunecloth", "=q2=Enchanted Runecloth Bag", "=ds=#sr# =so1=275 =so2=290 =so3=305 =so4=320" },
		...
		--Added in 1.9 { "s26086", "inv_misc_bag_felclothbag", "=q3=Felcloth Bag", "=ds=#sr# =so1=280 =so2=300 =so3=315 =so4=330" },
		...
		--Added in 1.6 { "s23664", "inv_boots_cloth_03", "=q3=Argent Boots", "=ds=#sr# =so1=290 =so2=305 =so3=320 =so4=335" },
	};

	TailoringArtisan3 = {
		{ "s18440", "inv_pants_13", "=q3=Mooncloth Leggings", "=ds=#sr# =so1=290 =so2=305 =so3=320 =so4=335" },
		--Added in 1.6 { "s23662", "inv_belt_09", "=q3=Wisdom of the Timbermaw", "=ds=#sr# =so1=290 =so2=305 =so3=320 =so4=335" },
		{ "s18444", "inv_misc_bandana_03", "=q2=Runecloth Headband", "=ds=#sr# =so1=295 =so2=310 =so3=325 =so4=340" },
		--Added in 1.10 { "s27660", "inv_misc_bag_bigbagofenchantments", "=q2=Big Bag of Enchantment", "=ds=#sr# =so1=300 =so2=315 =so3=330 =so4=345" },
		...
		--Changed in 1.3 { "s18445", "inv_misc_bag_14", "=q2=Mooncloth Bag", "=ds=#sr# =so1=300 =so2=315 =so3=330 =so4=345" },
		{ "s18445", "inv_misc_bag_14", "=q1=Mooncloth Bag", "=ds=#sr# =so1=300 =so2=315 =so3=330 =so4=345" },
		{ "s18449", "inv_shoulder_21", "=q2=Runecloth Shoulders", "=ds=#sr# =so1=300 =so2=315 =so3=330 =so4=345" },
		--Added in 1.10 { "s27725", "inv_misc_bag_satchelofcenarius", "=q2=Satchel of Cenarius", "=ds=#sr# =so1=300 =so2=315 =so3=330 =so4=345" },
		...
		--Added in 1.6 { "s23665", "inv_shoulder_13", "=q3=Argent Shoulders", "=ds=#sr# =so1=300 =so2=315 =so3=330 =so4=345" },
		--Added in 1.7 { "s24093", "inv_boots_cloth_02", "=q3=Bloodvine Boots", "=ds=#sr# =so1=300 =so2=315 =so3=330 =so4=345" },
		--Added in 1.7 { "s24092", "inv_pants_cloth_14", "=q3=Bloodvine Leggings", "=ds=#sr# =so1=300 =so2=315 =so3=330 =so4=345" },
		--Added in 1.7 { "s24091", "inv_chest_cloth_07", "=q3=Bloodvine Vest", "=ds=#sr# =so1=300 =so2=315 =so3=330 =so4=345" },
		{ "s18455", "inv_misc_bag_13", "=q3=Bottomless Bag", "=ds=#sr# =so1=300 =so2=315 =so3=330 =so4=345" },
		--Added in 1.3 { "s22870", "inv_misc_cape_06", "=q3=Cloak of Warding", "=ds=#sr# =so1=300 =so2=315 =so3=330 =so4=345" },
		--Added in 1.3 { "s22867", "inv_gauntlets_19", "=q3=Felcloth Gloves", "=ds=#sr# =so1=300 =so2=315 =so3=330 =so4=345" },
		--Added in 1.11 { "s28210", "inv_misc_cape_17", "=q3=Gaea's Embrace", "=ds=#sr# =so1=300 =so2=315 =so3=330 =so4=345" },
		--Added in 1.3 { "s22868", "inv_gauntlets_19", "=q3=Inferno Gloves", "=ds=#sr# =so1=300 =so2=315 =so3=330 =so4=345" },
		--Added in 1.6 { "s23663", "inv_shoulder_19", "=q3=Mantle of the Timbermaw", "=ds=#sr# =so1=300 =so2=315 =so3=330 =so4=345" },
		{ "s18452", "inv_misc_bandana_01", "=q3=Mooncloth Circlet", "=ds=#sr# =so1=300 =so2=315 =so3=330 =so4=345" },
		--Added in 1.3 { "s22869", "inv_gauntlets_17", "=q3=Mooncloth Gloves", "=ds=#sr# =so1=300 =so2=315 =so3=330 =so4=345" },
		--Added in 1.3 { "s22902", "inv_chest_cloth_04", "=q3=Mooncloth Robe", "=ds=#sr# =so1=300 =so2=315 =so3=330 =so4=345" },
		...
		--Added in 1.8 { "s24902", "inv_belt_14", "=q3=Runed Stygian Belt", "=ds=#sr# =so1=300 =so2=315 =so3=330 =so4=345" },
		--Added in 1.8 { "s24903", "inv_boots_05", "=q3=Runed Stygian Boots", "=ds=#sr# =so1=300 =so2=315 =so3=330 =so4=345" },
		--Added in 1.8 { "s24901", "inv_pants_cloth_05", "=q3=Runed Stygian Leggings", "=ds=#sr# =so1=300 =so2=315 =so3=330 =so4=345" },
		--Added in 1.11 { "s28481", "inv_crown_01", "=q3=Sylvan Crown", "=ds=#sr# =so1=300 =so2=315 =so3=330 =so4=345" },
		--DELETE BELOW IN 1.3
	...
	TailoringArtisan4 = {
		--Added in 1.11 { "s28482", "inv_shoulder_18", "=q3=Sylvan Shoulders", "=ds=#sr# =so1=300 =so2=315 =so3=330 =so4=345" },
		--Added in 1.11 { "s28480", "inv_chest_plate07", "=q3=Sylvan Vest", "=ds=#sr# =so1=300 =so2=315 =so3=330 =so4=345" },
		--Added in 1.3 { "s22866", "inv_belt_31", "=q4=Belt of the Archmage", "=ds=#sr# =so1=300 =so2=315 =so3=330 =so4=345" },
		--Added in 1.9 { "s26087", "inv_misc_bag_corefelclothbag", "=q4=Core Felcloth Bag", "=ds=#sr# =so1=300 =so2=315 =so3=330 =so4=345" },
		{ "s20849", "inv_gauntlets_26", "=q4=Flarecore Gloves", "=ds=#sr# =so1=300 =so2=315 =so3=330 =so4=345" },
		--Added in 1.6 { "s23667", "inv_pants_06", "=q4=Flarecore Leggings", "=ds=#sr# =so1=300 =so2=315 =so3=330 =so4=345" },
		{ "s20848", "inv_shoulder_23", "=q4=Flarecore Mantle", "=ds=#sr# =so1=300 =so2=315 =so3=330 =so4=345" },
		--Added in 1.6 { "s23666", "inv_chest_cloth_18", "=q4=Flarecore Robe", "=ds=#sr# =so1=300 =so2=315 =so3=330 =so4=345" },
		--Added in 1.4 { "s22759", "inv_bracer_09", "=q4=Flarecore Wraps", "=ds=#sr# =so1=300 =so2=315 =so3=330 =so4=345" },
		--Added in 1.11 { "s28208", "inv_misc_cape_16", "=q4=Glacial Cloak", "=ds=#sr# =so1=300 =so2=315 =so3=330 =so4=345" },
		--Added in 1.11 { "s28205", "inv_gauntlets_06", "=q4=Glacial Gloves", "=ds=#sr# =so1=300 =so2=315 =so3=330 =so4=345" },
		--Added in 1.11 { "s28207", "inv_chest_cloth_08", "=q4=Glacial Vest", "=ds=#sr# =so1=300 =so2=315 =so3=330 =so4=345" },
		--Added in 1.11 { "s28209", "inv_bracer_07", "=q4=Glacial Wrists", "=ds=#sr# =so1=300 =so2=315 =so3=330 =so4=345" },
	    { "s18454", "inv_gauntlets_06", "=q4=Gloves of Spell Mastery", "=ds=#sr# =so1=300 =so2=315 =so3=330 =so4=345" },
		{ "s18457", "inv_chest_cloth_38", "=q4=Robe of the Archmage", "=ds=#sr# =so1=300 =so2=315 =so3=330 =so4=345" },
		{ "s18458", "inv_chest_cloth_51", "=q4=Robe of the Void", "=ds=#sr# =so1=300 =so2=315 =so3=330 =so4=345" },
		{ "s18456", "inv_chest_cloth_31", "=q4=Truefaith Vestments", "=ds=#sr# =so1=300 =so2=315 =so3=330 =so4=345" },
...
-----------------
	...
	EngineeringJourneyman1 = {
		...
		--Added in 1.9 { "s26416", "inv_misc_missilesmall_blue", "=q1=Small Blue Rocket", "=ds=#sr# =so1=125 =so2=125 =so3=137 =so4=150" },
		--Added in 1.9 { "s26417", "inv_misc_missilesmall_green", "=q1=Small Green Rocket", "=ds=#sr# =so1=125 =so2=125 =so3=137 =so4=150" },
		--Added in 1.9 { "s26418", "inv_misc_missilesmall_red", "=q1=Small Red Rocket", "=ds=#sr# =so1=125 =so2=125 =so3=137 =so4=150" },
		...
		--Changed in 1.4 { "s3952", "inv_gizmo_07", "=q2=Minor Recombobulator", "=ds=#sr# =so1=140 =so2=165 =so3=177 =so4=190" },
		{ "s3952", "inv_gizmo_07", "=q1=Minor Recombobulator", "=ds=#sr# =so1=140 =so2=165 =so3=177 =so4=190" },
	...
	EngineeringExpert1 = {
		...
		--Added in 1.9 { "s26420", "inv_misc_missilelarge_blue", "=q1=Large Blue Rocket", "=ds=#sr# =so1=175 =so2=175 =so3=187 =so4=200" },
		--Added in 1.9 { "s26421", "inv_misc_missilelarge_green", "=q1=Large Green Rocket", "=ds=#sr# =so1=175 =so2=175 =so3=187 =so4=200" },
		--Added in 1.9 { "s26422", "inv_misc_missilelarge_red", "=q1=Large Red Rocket", "=ds=#sr# =so1=175 =so2=175 =so3=187 =so4=200" },
		...
		--Added in 1.4 { "s23069", "inv_misc_bomb_03", "=q1=EZ-Thro Dynamite II", "=ds=#sr# =so1=200 =so2=200 =so3=210 =so4=220" },
	...
	EngineeringExpert2 = {
		...
		--Added in 1.9 { "s26423", "inv_misc_missilesmallcluster_blue", "=q1=Blue Rocket Cluster", "=ds=#sr# =so1=225 =so2=225 =so3=237 =so4=250" },
		--Added in 1.9 { "s26424", "inv_misc_missilesmallcluster_green", "=q1=Green Rocket Cluster", "=ds=#sr# =so1=225 =so2=225 =so3=237 =so4=250" },
		--Added in 1.9 { "s26425", "inv_misc_missilesmallcluster_red", "=q1=Red Rocket Cluster", "=ds=#sr# =so1=225 =so2=225 =so3=237 =so4=250" },
	...
	EngineeringArtisan1 = {
		...
		--Added in 1.4 { "s23070", "inv_misc_bomb_06", "=q1=Dense Dynamite", "=ds=#sr# =so1=250 =so2=250 =so3=260 =so4=270" },
		--Added in 1.5 { "s23507", "spell_holy_holybolt", "=q1=Snake Burst Firework", "=ds=#sr# =so1=250 =so2=250 =so3=260 =so4=270" },
		{ "s19567", "inv_egg_05", "=q1=Salt Shaker", "=ds=#sr# =so1=250 =so2=270 =so3=280 =so4=290" },
		--Changedin 1.4 { "s12624", "inv_misc_head_dragon_01", "=q2=Mithril Mechanical Dragonling", "=ds=#sr# =so1=250 =so2=270 =so3=280 =so4=290" },
		{ "s12624", "inv_misc_head_dragon_01", "=q1=Mithril Mechanical Dragonling", "=ds=#sr# =so1=250 =so2=270 =so3=280 =so4=290" },
		--Added in 1.9 { "s26011", "ability_hunter_pet_gorilla", "=q1=Tranquil Mechanical Yeti", "=ds=#sr# =so1=250 =so2=320 =so3=330 =so4=340" },
		--Added in 1.4 { "s23071", "inv_staff_18", "=q1=Truesilver Transformer", "=ds=#sr# =so1=260 =so2=270 =so3=275 =so4=280" },
		...
		--Added in 1.4 { "s23077", "inv_misc_enggizmos_02", "=q3=Gyrofreeze Ice Reflector", "=ds=#sr# =so1=260 =so2=280 =so3=290 =so4=300" },
		...
		--Added in 1.9 { "s26426", "inv_misc_missilelargecluster_blue", "=q1=Large Blue Rocket Cluster", "=ds=#sr# =so1=275 =so2=275 =so3=280 =so4=285" },
		--Added in 1.9 { "s26427", "inv_misc_missilelargecluster_green", "=q1=Large Green Rocket Cluster", "=ds=#sr# =so1=275 =so2=275 =so3=280 =so4=285" },
		--Added in 1.9 { "s26428", "inv_misc_missilelargecluster_red", "=q1=Large Red Rocket Cluster", "=ds=#sr# =so1=275 =so2=275 =so3=280 =so4=285" },
		--Added in 1.4 { "s23080", "spell_shadow_detectinvisibility", "=q1=Powerful Seaforium Charge", "=ds=#sr# =so1=275 =so2=275 =so3=285 =so4=295" },
		--Added in 1.4 { "s23079", "inv_misc_enggizmos_09", "=q2=Major Recombobulator", "=ds=#sr# =so1=275 =so2=285 =so3=290 =so4=295" },
	...
	EngineeringArtisan2 = {
		...
		--Added in 1.4 { "s23081", "inv_misc_enggizmos_04", "=q3=Hyper-Radiant Flame Reflector", "=ds=#sr# =so1=290 =so2=310 =so3=320 =so4=330" },
		{ "s19831", "spell_shadow_mindbomb", "=q1=Arcane Bomb", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.3 { "s22704", "inv_egg_05", "=q1=Field Repair Bot 74A", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		{ "s19830", "inv_misc_head_dragon_01", "=q3=Arcanite Dragonling", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.4 { "s22793", "inv_misc_spyglass_02", "=q3=Biznicks 247x128 Accurascope", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.7 { "s24356", "inv_helmet_47", "=q3=Bloodvine Goggles", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.7 { "s24357", "inv_helmet_44", "=q3=Bloodvine Lens", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		{ "s19833", "inv_weapon_rifle_03", "=q3=Flawless Arcanite Rifle", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.4 { "s23082", "inv_misc_enggizmos_16", "=q3=Ultra-Flash Shadow Reflector", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.4 { "s22795", "inv_weapon_rifle_05", "=q4=Core Marksman Rifle", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		--Added in 1.4 { "s22797", "spell_arcane_portaldarnassus", "=q4=Force Reactive Disk", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
	};
	...
	Gnomish1 = {
		...
		--Added in 1.4 { "s23129", "inv_misc_enggizmos_08", "=q2=World Enlarger", "=ds=#sr# =so1=260 =so2=260 =so3=265 =so4=270" },
		--Added in 1.5 { "s23489", "inv_misc_enggizmos_12", "=q2=Ultrasafe Transporter - Gadgetzan", "=ds=#sr# =so1=260 =so2=285 =so3=295 =so4=305" },
		--Added in 1.4 { "s23096", "inv_misc_enggizmos_13", "=q1=Alarm-O-Bot", "=ds=#sr# =so1=265 =so2=275 =so3=280 =so4=285" },
	};
	...
	Goblin1 = {
		...
		--Added in 1.5 { "s23486", "inv_misc_enggizmos_07", "=q2=Dimensional Ripper - Everlook", "=ds=#sr# =so1=260 =so2=285 =so3=295 =so4=305" },
		--Added in 1.4 { "s23078", "inv_misc_enggizmos_11", "=q1=Goblin Jumper Cables XL", "=ds=#sr# =so1=265 =so2=285 =so3=295 =so4=305" },
	};
...
------------
	...
	Mining1 = {
		...
		--Added in 1.7 { "s100019", "inv_ore_thorium_02", "=ds=Hakkari Thorium Vein", "=ds=#sr# =so1=275 =so2=300 =so3=325 =so4=350" },
		--Added in 1.7 { "s100020", "inv_misc_gem_01", "=ds=Hakkari Thorium Vein", "=ds=#sr# =so1=275 =so2=300 =so3=325 =so4=350" },
		--Added in 1.10 { "s100021", "inv_misc_stonetablet_01", "=ds=Small Obsidian Chunk", "=ds=#sr# =so1=305 =so2=330 =so3=355 =so4=370" },
		--Added in 1.10 { "s100022", "inv_stone_15", "=ds=Small Obsidian Chunk", "=ds=#sr# =so1=305 =so2=330 =so3=355 =so4=370" },
	};

	Mining2 = {
		--Added in 1.10 { "s100023", "inv_misc_stonetablet_01", "=ds=Large Obsidian Chunk", "=ds=#sr# =so1=305 =so2=330 =so3=355 =so4=370" },
		--Added in 1.10 { "s100024", "inv_stone_15", "=ds=Large Obsidian Chunk", "=ds=#sr# =so1=305 =so2=330 =so3=355 =so4=370" },
	};
	...
	Smelting1 = {
		...
		--Added in 1.6 { "s22967", "inv_ingot_thorium", "=q5=Smelt Elementium", "=ds=#sr# =so1=300 =so2=350 =so3=362 =so4=375" },
	};
...
-------------
	...
	Herbalism2 = {
		...
		--Added in 1.7 { 19726, "inv_misc_herb_09", "=q2=Bloodvine", "=ds=#sr# =so1=-- =so2=-- =so3=-- =so4=--" },
	};
...
-------------
	...
	CookingExpert1 = {
		...
		--Added in 1.3 { "s22480", "inv_misc_food_47", "=q1=Tender Wolf Steak", "=ds=#sr# =so1=225 =so2=265 =so3=285 =so4=305" },
	...
	CookingArtisan1 = {
		...
		--Added in 1.3 { "s22761", "inv_misc_food_63", "=q1=Runn Tum Tuber Surprise", "=ds=#sr# =so1=275 =so2=315 =so3=335 =so4=355" },
		--Added in 1.8 { "s24801", "inv_misc_food_64", "=q1=Smoked Desert Dumplings", "=ds=#sr# =so1=285 =so2=325 =so3=345 =so4=365" },
		--Added in 1.9 { "s25659", "inv_misc_food_65", "=q1=Dirge's Kickin' Chimaerok Chops", "=ds=#sr# =so1=300 =so2=325 =so3=345 =so4=365" },
	};
...
--------------
	...
	FirstAid1 = {
		...
		--Added in 1.6 { "s23787", "inv_drink_14", "=q1=Powerful Anti-Venom", "=ds=#sr# =so1=300 =so2=300 =so3=330 =so4=360" },
	};
