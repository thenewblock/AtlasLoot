AtlasLoot_Data["AtlasLootRepItems"] = {
	...
	Argent2 = {
		{ 0, "", "", "" },
		{ 0, "INV_Jewelry_Talisman_08", "=q6=#r3#", "" },
		--Move in 1.6 { 13482, "INV_Scroll_06", "=q2=Recipe: Transmute Air to Fire", "=ds=#p1# (275)" },
		--Added in 1.6 { 19216, "INV_Scroll_03", "=q1=Pattern: Argent Boots", "=ds=#p8# (290)" },
		--Added in 1.6 { 19328, "INV_Scroll_03", "=q1=Pattern: Dawn Treaders", "=ds=#p7# (290)" },
		--Added in 1.6 { 19203, "INV_Scroll_03", "=q1=Plans: Girdle of the Dawn", "=ds=#p2# (290)" },
		--Added in 1.6 { 19442, "INV_Scroll_03", "=q1=Formula: Powerful Anti-Venom", "=ds=#p6# (300)" },
		--Added in 1.6 { 19446, "INV_Misc_Note_01", "=q1=Formula: Enchant Bracer - Mana Regeneration", "=ds=#p4# (290)" },
	};--]]
	--[[ Added in 1.3
	Argent3 = {
		{ 0, "", "", "" },
		{ 0, "INV_Jewelry_Talisman_08", "=q6=#r4#", "" },
		--Added in 1.3 { 18171, "Spell_Holy_WordFortitude", "=q2=Arcane Mantle of the Dawn", "=ds=#s3# #e11#" },
		--Added in 1.3 { 18169, "Spell_Fire_FlameShock", "=q2=Flame Mantle of the Dawn", "=ds=#s3# #e11#" },
		--Added in 1.3 { 18170, "Spell_Frost_FrostShock", "=q2=Frost Mantle of the Dawn", "=ds=#s3# #e11#" },
		--Added in 1.3 { 18172, "Spell_Nature_ProtectionformNature", "=q2=Nature Mantle of the Dawn", "=ds=#s3# #e11#" },
		--Added in 1.3 { 18173, "Spell_Shadow_RagingScream", "=q2=Shadow Mantle of the Dawn", "=ds=#s3# #e11#" },
		--Added in 1.6 { 19217, "INV_Scroll_03", "=q1=Pattern: Argent Shoulders", "=ds=#p8# (300)" },
		--Added in 1.6 { 19329, "INV_Scroll_03", "=q1=Pattern: Golden Mantle of the Dawn", "=ds=#p7# (300)" },
		--Added in 1.6 { 19205, "INV_Scroll_03", "=q1=Plans: Gloves of the Dawn", "=ds=#p2# (300)" },
		--Added in 1.6 { 19447, "INV_Scroll_03", "=q1=Formula: Enchant Bracer - Healing", "=ds=#p4# (300)" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "INV_Jewelry_Talisman_08", "=q6=#r5#", "" },
		--Added in 1.3 { 18182, "INV_Misc_Gem_Variety_02", "=q2=Chromatic Mantle of the Dawn", "=ds=#s3# #e11#" },
	};--]]
	AQBroodRings = {
		{ 0, "", "", "" },
	...
	Timbermaw = {
		...
		--Added in 1.7 { 20254, "INV_Scroll_03", "=q1=Pattern: Warbear Woolies","=ds=#p7# (285)" },   		 
		{ 15742, "INV_Scroll_03", "=q1=Pattern: Warbear Harness","=ds=#p7# (275)" },
		--Added in 1.10 { 22392, "INV_Misc_Note_01", "=q1=Formula: Enchant 2H Weapon - Agility","=ds=#p4# (290)" },
		{ 0, "", "", "" },
		...
		--Added in 1.6 { 19202, "INV_Scroll_03", "=q1=Plans: Heavy Timbermaw Belt","=ds=#p2# (290)" },
		--Added in 1.6 { 19326, "INV_Scroll_03", "=q1=Pattern: Might of the Timbermaw","=ds=#p7# (290)" },
		--Added in 1.6 { 19215, "INV_Scroll_03", "=q1=Pattern: Wisdom of the Timbermaw","=ds=#p8# (290)" },
		--Added in 1.6 { 19445, "INV_Misc_Note_01", "=q1=Formula: Enchant Weapon - Agility","=ds=#p4# (290)" },
		{ 0, "", "", "" },
		--Added in 1.6 { 0, "INV_Misc_Horn_01", "=q6=#r4#", "" },
		--Added in 1.6 { 19218, "INV_Scroll_03", "=q1=Pattern: Mantle of the Timbermaw","=ds=#p8# (300)" },  
		--Added in 1.6 { 19327, "INV_Scroll_03", "=q1=Pattern: Timbermaw Brawlers","=ds=#p7# (300)" },  
		--Added in 1.6 { 19204, "INV_Scroll_03", "=q1=Plans: Heavy Timbermaw Boots","=ds=#p2# (300)" },
		--Added in 1.9 { 0, "", "", "" },
		--Added in 1.9 { 0, "INV_Misc_Horn_01", "=q6=#r5#", "" },		
		--Added in 1.9 { 21326, "INV_Misc_Horn_01", "=q4=Defender of the Timbermaw", "=ds=#s14#"},
	};
	Thorium1 = {
		{ 0, "", "", "" },
		...
		--Added in 1.6 { 20761, "INV_Scroll_03", "=q1=Recipe: Transmute Elemental Fire", "=ds=#p1# (300)" },
		--Added in 1.6 { 19444, "INV_Misc_Note_01", "=q1=Formula: Enchant Weapon - Strength", "=ds=#p4# (290)" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		...
		--Added in 1.6 { 19219, "INV_Scroll_03", "=q1=Pattern: Flarecore Robe", "=ds=#p8# (300)" },
		--Added in 1.6 { 19330, "INV_Scroll_03", "=q1=Pattern: Lava Belt", "=ds=#p7# (300)" },
		{ 17025, "INV_Scroll_03", "=q1=Pattern: Black Dragonscale Boots", "=ds=#p7# (300)" },
		--Added in 1.6 { 19206, "INV_Scroll_03", "=q1=Plans: Dark Iron Helm", "=ds=#p2# (300)" },
		--Added in 1.6 { 19448, "INV_Misc_Note_01", "=q1=Formula: Enchant Weapon - Mighty Spirit", "=ds=#p4# (300)" },  
	};
	Thorium2 = {
		{ 0, "", "", "" },
		{ 0, "INV_Ingot_Mithril", "=q6=#r4#", "" },
		--Added in 1.4 { 18592, "INV_Scroll_03", "=q4=Plans: Sulfuron Hammer", "=ds=#p2#, #m4#" },
		{ 17052, "INV_Scroll_03", "=q3=Plans: Dark Iron Leggings", "=ds=#p2# (300)" },
		{ 17053, "INV_Scroll_03", "=q3=Plans: Fiery Chain Shoulders", "=ds=#p2# (300)" },
		--Added in 1.6 { 19220, "INV_Scroll_03", "=q1=Pattern: Flarecore Leggings", "=ds=#p8# (300)" },
		--Added in 1.6 { 19333, "INV_Scroll_03", "=q1=Pattern: Molten Belt", "=ds=#p7# (300)" },
		--Added in 1.6 { 19332, "INV_Scroll_03", "=q1=Pattern: Corehound Belt", "=ds=#p7# (300)" }, 
		--Added in 1.6 { 19331, "INV_Scroll_03", "=q1=Pattern: Chromatic Gauntlets", "=ds=#p7# (300)" },
		--Added in 1.6 { 19207, "INV_Scroll_03", "=q1=Plans: Dark Iron Gauntlets", "=ds=#p2# (300)" },
		--Added in 1.6 { 19208, "INV_Scroll_03", "=q1=Plans: Black Amnesty", "=ds=#p2# (300)" },
		--Added in 1.6 { 19209, "INV_Scroll_03", "=q1=Plans: Blackfury", "=ds=#p2# (300)" },		
		--Added in 1.6 { 19449, "INV_Scroll_03", "=q1=Formula: Enchant Weapon - Mighty Intellect", "=ds=#p4# (300)" }, 
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		--Added in 1.6 { 0, "INV_Ingot_Mithril", "=q6=#r5#", "" },
		--Added in 1.6 { 20040, "INV_Scroll_03", "=q1=Plans: Dark Iron Boots", "=ds=#p2# (300)" },	
		--Added in 1.6 { 19210, "INV_Scroll_03", "=q1=Plans: Ebon Hand", "=ds=#p2# (300)" },  
		--Added in 1.6 { 19211, "INV_Scroll_03", "=q1=Plans: Blackguard", "=ds=#p2# (300)" }, 
		--Added in 1.6 { 19212, "INV_Scroll_03", "=q1=Plans: Nightfall", "=ds=#p2# (300)" },
	};
	Cenarion1 = {
		{ 0, "", "", "" },
	...
	Wintersaber1 = {
		{ 0, "", "", "" },
		{ 0, "INV_Box_01", "=q6=#r5#", "" },
		--Changed in 1.12 { 13086, "Ability_Mount_PinkTiger", "=q4=Reins of the Winterspring Frostsaber", "=ds=#e7#" },
		{ 13086, "Ability_Mount_PinkTiger", "=q1=Reins of the Winterspring Frostsaber", "=ds=#e7#" },
	};
	Stormpike1 = {
		{ 0, "", "", "" },
	...
	WaterLords1 = {
		...
		--Added in 1.3 { 18399, "INV_Jewelry_Ring_28", "=q3=Ocean's Breeze", "=q1=#m4# =ds=#s13#" },
		--Added in 1.3 { 18398, "INV_Jewelry_Ring_10", "=q3=Tidal Loop", "=q1=#m4# =ds=#s13#" },
		{ 17333, "INV_Potion_76", "=q1=Aqual Quintessence", "=ds=#m20#" },
		--Added in 1.11 { 0, "", "", "" },
		--Added in 1.11 { 0, "Spell_Frost_FrostArmor", "=q6=#r4#", "" },
		--Added in 1.11 { 22754, "INV_Potion_83", "=q1=Eternal Quintessence", "=ds=#m20#" },
	};
	Bloodsail1 = {
		--[[ Added in 1.11
		{ 0, "", "", "" },
