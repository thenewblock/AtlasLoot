...
AtlasLoot_Data["AtlasLootItems"] = {
	...
	MCLucifron = {
		...
		{ 0,"","","" },
		{ 0,"","","" },
		--Added in 1.4 { 18870, "INV_Helmet_18", "=q4=Helm of the Lifegiver", "=ds=#s1#, #a3#", "1.09%" },
		{ 17109, "INV_Jewelry_Necklace_10", "=q4=Choker of Enlightenment", "=ds=#s2#", "12.61%" },
		--Added in 1.5 { 19145, "INV_Chest_Cloth_18", "=q4=Robe of Volatile Power", "=ds=#s5#, #a1#", "1.84%" },
		--Added in 1.5 { 19146, "INV_Bracer_04", "=q4=Wristguards of Stability", "=ds=#s8#, #a2#", "1.95%" },
		--Added in 1.4 { 18872, "INV_Pants_08", "=q4=Manastorm Leggings", "=ds=#s11#, #a1#", "1.93%" },
		--Added in 1.4 { 18875, "INV_Pants_12", "=q4=Salamander Scale Pants", "=ds=#s11#, #a2#", "2.00%" },
		--Added in 1.4 { 18861, "INV_Pants_04", "=q4=Flamewaker Legplates", "=ds=#s11#, #a4#", "2.15%" },
		--Added in 1.4 { 18879, "INV_Jewelry_Ring_14", "=q4=Heavy Dark Iron Ring", "=ds=#s13#", "2.04%" },
		--Added in 1.5 { 19147, "INV_Jewelry_Ring_38", "=q4=Ring of Spell Power", "=ds=#s13#", "2.23%" },
		{ 17077, "INV_Staff_13", "=q4=Crimson Shocker", "=ds=#w12#", "1.60%" },
		--Added in 1.4 { 18878, "INV_Weapon_ShortBlade_07", "=q4=Sorcerous Dagger", "=ds=#h3#, #w4#", "2.23%" },
		{ 0,"","","" },
		{ 0,"","","" },
		{ 0,"","","" },
	...
	MCMagmadar = {
		...
		--Added in 1.4 { 18829, "INV_Shoulder_04", "=q4=Deep Earth Spaulders", "=ds=#s3#, #a3#", "2.10%" },
		--Added in 1.4 { 18823, "INV_Gauntlets_23", "=q4=Aged Core Leather Gloves", "=ds=#s9#, #a2#", "6.18%" },
		--Added in 1.5 { 19143, "INV_Gauntlets_26", "=q4=Flameguard Gauntlets", "=ds=#s9#, #a4#", "5.48%" },
		--Added in 1.5 { 19136, "INV_Belt_11", "=q4=Mana Igniting Cord", "=ds=#s10#, #a1#", "4.79%" },
		--Added in 1.4 { 18861, "INV_Pants_04", "=q4=Flamewaker Legplates", "=ds=#s11#, #a4#", "3.98%" },
		--Added in 1.5 { 19144, "INV_Boots_Chain_05", "=q4=Sabatons of the Flamewalker", "=ds=#s12#, #a3#", "1.86%" },
		--Added in 1.4 { 18824, "INV_Boots_Plate_08", "=q4=Magma Tempered Boots", "=ds=#s12#, #a4#", "3.22%" },
		--Added in 1.4 { 18821, "INV_Jewelry_Ring_07", "=q4=Quick Strike Ring", "=ds=#s13#", "5.79%" },
		--Added in 1.4 { 18820, "INV_Misc_StoneTablet_11", "=q4=Talisman of Ephemeral Power", "=ds=#s14#", "5.55%" },
		--Added in 1.5 { 19142, "INV_Misc_Book_09", "=q4=Fire Runed Grimoire", "=ds=#s15#", "5.42%" },
		{ 17069, "INV_Weapon_Bow_08", "=q4=Striker's Mark", "=ds=#w2#", "16.37%" },
		--Added in 1.3 { 18203, "INV_Misc_MonsterClaw_04", "=q4=Eskhandar's Right Claw", "=ds=#h3#, #w13#", "17.82%" },
		{ 17073, "INV_Hammer_04", "=q4=Earthshaker", "=ds=#h2#, #w6#", "16.75%" },
		--Added in 1.4 { 18822, "INV_Sword_28", "=q4=Obsidian Edged Blade", "=ds=#h2#, #w10#", "5.68%" },
	};
	MCGehennas = {
	...
	MCGarr = {
		...
		{ 0,"","","" },
		{ 0,"","","" },
		--Added in 1.6 { 18564, "Spell_Ice_Lament", "=q5=Bindings of the Windseeker", "=q1=#m3# =ds=#m9#", "3.74%" },
		--Added in 1.6 { 19019, "INV_Sword_39", "=q5=Thunderfury, Blessed Blade of the Windseeker", "=q1=#m4# =ds=#h1#, #w10#" },
		--Added in 1.4 { 18829, "INV_Shoulder_04", "=q4=Deep Earth Spaulders", "=ds=#s3#, #a3#", "2.10%" },
		--Added in 1.4 { 18823, "INV_Gauntlets_23", "=q4=Aged Core Leather Gloves", "=ds=#s9#, #a2#", "6.18%" },
		--Added in 1.5 { 19143, "INV_Gauntlets_26", "=q4=Flameguard Gauntlets", "=ds=#s9#, #a4#", "5.48%" },
		--Added in 1.5 { 19136, "INV_Belt_11", "=q4=Mana Igniting Cord", "=ds=#s10#, #a1#", "4.79%" },
		...
		--Added in 1.4 { 18832, "INV_Sword_15", "=q4=Brutality Blade", "=ds=#h1#, #w10#", "13.27%" },
		--Added in 1.4 { 18822, "INV_Sword_28", "=q4=Obsidian Edged Blade", "=ds=#h2#, #w10#", "5.68%" },
	};
	MCShazzrah = {
	...
	MCGeddon = {
		...
		{ 0,"","","" },
		{ 0,"","","" },
		--Added in 1.6 { 18563, "Spell_Ice_Lament", "=q5=Bindings of the Windseeker", "=q1=#m3# =ds=#m10#", "3.78%" },
		--Added in 1.6 { 19019, "INV_Sword_39", "=q5=Thunderfury, Blessed Blade of the Windseeker", "=q1=#m4# =ds=#h1#, #w10#" },
		--Added in 1.4 { 18829, "INV_Shoulder_04", "=q4=Deep Earth Spaulders", "=ds=#s3#, #a3#", "2.10%" },
		--Added in 1.4 { 18823, "INV_Gauntlets_23", "=q4=Aged Core Leather Gloves", "=ds=#s9#, #a2#", "6.18%" },
		--Added in 1.5 { 19143, "INV_Gauntlets_26", "=q4=Flameguard Gauntlets", "=ds=#s9#, #a4#", "5.48%" },
	...
	MCGolemagg = {
		...
		{ 0,"","","" },
		{ 0,"","","" },
		--Added in 1.4 { 17203, "Spell_Fire_SealOfFire", "=q4=Sulfuron Ingot", "=q1=#m3#=ds=, =q1=#m26#", "11.98%" },
		--Added in 1.4 { 17182, "INV_Hammer_Unique_Sulfuras", "=q5=Sulfuras, Hand of Ragnaros", "=ds=#h2#, #w6#" },
		--Added in 1.4 { 18829, "INV_Shoulder_04", "=q4=Deep Earth Spaulders", "=ds=#s3#, #a3#", "2.10%" },
		--Added in 1.4 { 18823, "INV_Gauntlets_23", "=q4=Aged Core Leather Gloves", "=ds=#s9#, #a2#", "6.18%" },
		--Added in 1.5 { 19143, "INV_Gauntlets_26", "=q4=Flameguard Gauntlets", "=ds=#s9#, #a4#", "5.48%" },
		--Added in 1.5 { 19136, "INV_Belt_11", "=q4=Mana Igniting Cord", "=ds=#s10#, #a1#", "4.79%" },
		...
		--Added in 1.4 { 18822, "INV_Sword_28", "=q4=Obsidian Edged Blade", "=ds=#h2#, #w10#", "5.68%" },
		--Added in 1.4 { 18842, "INV_Staff_13", "=q4=Staff of Dominance", "=ds=#w9#", "18.95%" },
	};
	MCSulfuron = {
	...
	MCMajordomo = {
		--Added in 1.5 { 19139, "INV_Shoulder_23", "=q4=Fireguard Shoulders", "=ds=#s3#, #a2#", "15.87%" },
		--Added in 1.4 { 18810, "INV_Shoulder_18", "=q4=Wild Growth Spaulders", "=ds=#s3#, #a2#", "16.91%" },
		--Added in 1.4 { 18811, "INV_Misc_Cape_18", "=q4=Fireproof Cloak", "=ds=#s4#", "15.12%" },
		--Added in 1.4 { 18808, "INV_Gauntlets_03", "=q4=Gloves of the Hypnotic Flame", "=ds=#s9#, #a1#", "15.36%" },
		--Added in 1.4 { 18809, "INV_Belt_12", "=q4=Sash of Whispered Secrets", "=ds=#s10#, #a1#", "15.93%" },
		--Added in 1.4 { 18812, "INV_Bracer_02", "=q4=Wristguards of True Flight", "=ds=#s8#, #a3#", "18.04%" },
		--Added in 1.4 { 18806, "INV_Boots_Plate_09", "=q4=Core Forged Greaves", "=ds=#s12#, #a4#", "16.53%" },
		--Added in 1.5 { 19140, "INV_Jewelry_Ring_39", "=q4=Cauterizing Band", "=ds=#s13#", "15.10%" },
		--Added in 1.4 { 18805, "INV_Weapon_ShortBlade_11", "=q4=Core Hound Tooth", "=ds=#h1#, #w4#", "16.06%" },
		--Added in 1.4 { 18803, "INV_Gizmo_02", "=q4=Finkle's Lava Dredger", "=ds=#h2#, #w6#", "12.43%" },
		{ 0,"","","" },
		{ 0,"","","" },
		{ 0,"","","" },
		{ 0,"","","" },
		{ 0,"","","" },
		--Added in 1.4 { 18703, "Spell_Nature_ResistNature", "=q4=Ancient Petrified Leaf", "=ds=#m2# =q14=#c2#", "35.25%" },
		--Added in 1.4 { 18714, "INV_Misc_Quiver_03", "=q4=Ancient Sinew Wrapped Lamina", "=q1=#m4# =ds=#e9# =q14=#c2#" },
		--Added in 1.4 { 18713, "INV_Weapon_Bow_01", "=q4=Rhok'delar, Longbow of the Ancient Keepers", "=q1=#m4# =ds=#w2# =q14=#c2#" },
		--Added in 1.4 { 18715, "INV_Staff_21", "=q4=Lok'delar, Stave of the Ancient Keepers", "=q1=#m4# =ds=#w9# =q14=#c2#" },
		{ 0,"","","" },
		--Added in 1.4 { 18646, "Spell_Holy_MindSooth", "=q4=The Eye of Divinity", "=ds=#s14# =q9=#c5#", "28.30%" },
		--Added in 1.4 { 18608, "INV_Staff_30", "=q4=Benediction", "=q1=#m4# =ds=#w9# =q9=#c5#" },
		--Added in 1.4 { 18609, "INV_Staff_12", "=q4=Anathema", "=q1=#m4# =ds=#w9# =q9=#c5#" },
	};
	MCRagnaros = {
		...
		--Added in 1.4 { 0,"","","" },
		--Added in 1.4 { 17204, "INV_Misc_Gem_Pearl_05", "=q5=Eye of Sulfuras", "=q1=#m26#", "3.42%" },
		--Added in 1.4 { 17182, "INV_Hammer_Unique_Sulfuras", "=q5=Sulfuras, Hand of Ragnaros", "=ds=#h2#, #w6#" },
		{ 0,"","","" },
		{ 0,"","","" },
		{ 0,"","","" },
		...
		{ 0,"","","" },
		{ 0,"","","" },
		--Added in 1.6 { 19017, "Spell_Fire_SelfDestruct", "=q5=Essence of the Firelord", "=q1=#m3#", "100%" },
		--Added in 1.6 { 19019, "INV_Sword_39", "=q5=Thunderfury, Blessed Blade of the Windseeker", "=q1=#m4# =ds=#h1#, #w10#" },
		--Added in 1.4 { 18817, "INV_Crown_02", "=q4=Crown of Destruction", "=ds=#s1#, #a3#", "16.75%" },
		--Added in 1.4 { 18814, "INV_Jewelry_Amulet_05", "=q4=Choker of the Fire Lord", "=ds=#s2#", "16.08%" },
		...
		--Added in 1.5 { 19137, "INV_Belt_29", "=q4=Onslaught Girdle", 	"=ds=#s10#, #a4#", "13.18%" },
		{ 17063, "INV_Jewelry_Ring_15", "=q4=Band of Accuria", "=ds=#s13#", "14.81%" },
		--Added in 1.5 { 19138, "INV_Jewelry_Ring_36", "=q4=Band of Sulfuras", "=ds=#s13#", "15.64%" },
		--Added in 1.4 { 18815, "Spell_Fire_Fire", "=q4=Essence of the Pure Flame", "=ds=#s14#", "17.80%" },
		{ 17082, "INV_Misc_Orb_05", "=q4=Shard of the Flame", "=ds=#s14#", "4.65%" },
		{ 17106, "INV_Shield_08", "=q4=Malistar's Defender", "=ds=#w8#", "13.88%" },
		--Added in 1.4 { 18816, "INV_Sword_48", "=q4=Perdition's Blade", "=ds=#h1#, #w4#", "15.90%" },
	...
	MCRANDOMBOSSDROPS = {
		--Added in 1.4 { 18264, "INV_Scroll_05", "=q3=Plans: Elemental Sharpening Stone", "=ds=#p2# (300)", "1.02%" },
		--Added in 1.4 { 18262, "INV_Stone_02", "=q2=Elemental Sharpening Stone", "=ds=#e12#" },
		{ 0,"","","" },
		--Added in 1.4  18292, "INV_Scroll_05", "=q3=Schematic: Core Marksman Rifle", "=ds=#p5# (300)", "0.96%" },
		--Added in 1.4 { 18282, "INV_Weapon_Rifle_05", "=q4=Core Marksman Rifle", "=ds=#w5#" },
		{ 0,"","","" },
		--Added in 1.4 { 18291, "INV_Scroll_05", "=q3=Schematic: Force Reactive Disk", "=ds=#p5# (300)", "0.92%" },
		--Added in 1.4 { 18168, "Spell_Arcane_PortalDarnassus", "=q4=Force Reactive Disk", "=ds=#w8#" },
		{ 0,"","","" },
		--Added in 1.4 { 18290, "INV_Scroll_05", "=q3=Schematic: Biznicks 247x128 Accurascope", "=ds=#p5# (300)", "0.11%" },
		--Added in 1.4 { 18283, "INV_Misc_Spyglass_02", "=q3=Biznicks 247x128 Accurascope", "=ds=#e13#" },
		{ 0,"","","" },
		--Added in 1.4 { 18259, "INV_Misc_Note_01", "=q3=Formula: Enchant Weapon - Spell Power", "=ds=#p4# (300)", "0.85%" },
		{ 0,"","","" },
		{ 0,"","","" },
		--Added in 1.4 { 18252, "INV_Scroll_05", "=q3=Pattern: Core Armor Kit", "=ds=#p7# (300)", "0.85%" },
		--Added in 1.4 { 18251, "INV_Misc_ArmorKit_05", "=q3=Core Armor Kit", "=ds=#e12#" },
		{ 0,"","","" },
		--Added in 1.4 { 18265, "INV_Scroll_05", "=q3=Pattern: Flarecore Wraps", "=ds=#p8# (300)", "0.72%" },
		--Added in 1.4 { 18263, "INV_Bracer_09", "=q4=Flarecore Wraps", "=ds=#s8#, #a1#" },
		{ 0,"","","" },
		--Added in 1.9 { 21371, "INV_Scroll_05", "=q3=Pattern: Core Felcloth Bag", "=ds=#p8# (300)", "0.33%" },
		--Added in 1.9 { 21342, "INV_Misc_Bag_CoreFelclothBag", "=q4=Core Felcloth Bag", "=ds=#m11# =q11=#c8#" },
		{ 0,"","","" },
		--Added in 1.4 { 18257, "INV_Scroll_05", "=q3=Recipe: Major Rejuvenation Potion", "=ds=#p1# (300)", "0.76%" },
		--Added in 1.4 { 18253, "INV_Potion_47", "=q1=Major Rejuvenation Potion", "=ds=#e1#" },
		{ 0,"","","" },
		--Added in 1.4 { 18260, "INV_Misc_Note_01", "=q3=Formula: Enchant Weapon - Healing Power", "=ds=#p4# (300)", "0.75%" },
	};
	Onyxia = {
		...
		{ 0,"","","" },
		{ 0,"","","" },
		--Added in 1.3 { 18423, "INV_Misc_Head_Dragon_01", "=q4=Head of Onyxia", "=ds=#m2#", "100%" },
		--Added in 1.3 { 18404, "INV_Jewelry_Necklace_09", "=q4=Onyxia Tooth Pendant", "=q1=#m4# =ds=#s2#" },
		--Added in 1.3 { 18403, "INV_Jewelry_Ring_27", "=q4=Dragonslayer's Signet", "=q1=#m4# =ds=#s13#" },
		--Added in 1.3 { 18406, "Spell_Shadow_LifeDrain", "=q4=Onyxia Blood Talisman", "=q1=#m4# =ds=#s14#" },
		--Added in 1.6 { 15138,"INV_Misc_Cape_05","=q3=Onyxia Scale Cloak","=q1=#m4# =ds=#s4# =q5=#p17# (300)" },
		--Added in 1.4 { 18705, "Spell_Holy_DispelMagic", "=q4=Mature Black Dragon Sinew", "=ds=#m3# =q14=#c2#", "	24.53%" },
		--Added in 1.4 { 18713, "INV_Weapon_Bow_01", "=q4=Rhok'delar, Longbow of the Ancient Keepers", "=q1=#m4# =ds=#w2# =q14=#c2#" },
		{ 0,"","","" },
		--Added in 1.3 { 18205, "INV_Belt_12", "=q4=Eskhandar's Collar", "=ds=#s2#", "14.88%" },
		{ 17078, "INV_Misc_Cape_16", "=q4=Sapphiron Drape", "=ds=#s4#", "15.28%" },
		--Added in 1.4 { 18813, "INV_Jewelry_Ring_13", "=q4=Ring of Binding", "=ds=#s13#", "16.28%" },
		...
		{ 0,"","","" },
		--Added in 1.4 { 17966,"INV_Misc_Bag_22","=q2=Onyxia Hide Backpack","=ds=#m12#", "100%"},
		{ 17962,"INV_Misc_Bag_10_Blue","=q2=Blue Sack of Gems","=ds=#m23# =q2=#e25#", "20.50%" },
		{ 0,"","","" },
		--Changed in 1.3 { 15410, "INV_Misc_MonsterScales_07","=q3=Scale of Onyxia", "=ds=#e12# =q5=#p16# (315)" },
		{ 15410, "INV_Misc_MonsterScales_07","=q2=Onyxia Scale", "=ds=#e12# =q5=#p16# (315)" },
	};
		ZGJeklik = {
	...
	ZGGahzranka = {
		{ 19945, "INV_Helmet_46", "=q4=Foror's Ey", "=ds=#s1#, #a2#", "8,82%" },
 ...
 WCDeviateFaerieDragon = {
	...
	{ 0, "", "", "" },
	--Added in 1.8 { 20606, "INV_Feather_14","=q1=Amber Voodoo Feather", "=ds=#m3# =q7=#st1#, #st6#" },
	--Added in 1.8 { 20607, "INV_Feather_13","=q1=Blue Voodoo Feather", "=ds=#m3# =q7=#st2#, #st4#" },
	--Added in 1.8 { 20608, "INV_Feather_12","=q1=Green Voodoo Feather", "=ds=#m3# =q7=#st3#, #st5#" },
	};
	STSpawnOfHakkar = {
	...
	STTrash = {
		...
		{ 0,"","","" },
		--Changed in 1.6 { 16216, "INV_Misc_Note_01", "=q2=Formula: Enchant Cloak - Greater Resistance", "=ds=#p4# (265) =q7=#x78#", "1.45%" },
		{ 16216, "INV_Misc_Note_01", "=q1=Formula: Enchant Cloak - Greater Resistance", "=ds=#p4# (265) =q7=#x78#", "1.45%" },
	...
	UldEric ={
		...
		{ 0, "", "", "" },
		--Changed in 1.11 { 9398, "INV_Boots_02", "=q2=Worn Running Boots", "=ds=#s12#, #a2#", "45.09%" },
		{ 9398, "INV_Boots_02", "=q1=Worn Running Boots", "=ds=#s12#, #a2#", "45.09%" },
		{ 0, "", "", "" },
	...
	SMATrash = {
		...
		{ 0,"","","" },
		--Added in 1.11 {23192, "INV_Misc_Cape_18", "=q1=Tabard of the Scarlet Crusade", "=ds=#s7# =q7=#x64#", "1.6%"},
	};
	SMCTrash = {
		{ 5819, "INV_Helmet_03", "=q3=Sunblaze Coif", "=ds=#s1#, #a3#", "0.01%" },
		{ 7755, "INV_Shoulder_13", "=q3=Flintrock Shoulders", "=ds=#s3#, #a2#", "0.01%" },
	...
	BRDLordRoccor = {
		--Added in 1.10 { 22234, "INV_Shoulder_09", "=q3=Mantle of Lost Hope", "=ds=#s3#, #a1#", "20.48%" },
		--Changed in 1.10 { 11632, "INV_Shoulder_26", "=q3=Earthslag Shoulders", "=ds=#s3#, #a4#", "19.99%" },
		{ 11632, "INV_Shoulder_26", "=q2=Earthslag Shoulders", "=ds=#s3#, #a4#", "19.99%" },
		--Changed in 1.10 { 11631, "INV_Shield_02", "=q3=Stoneshell Guard", "=ds=#w8#", "22.06%" },
		{ 11631, "INV_Shield_02", "=q2=Stoneshell Guard", "=ds=#w8#", "22.06%" },
		--Added in 1.10 { 22397, "INV_Relics_IdolofFerocity", "=q3=Idol of Ferocity", "=ds=#s16#, #e16# =q13=#c1#", "19.58%" },
	...
	BRDHighInterrogatorGerstahn = {
		--Changed in 1.10  11626, "INV_Misc_Cape_18", "=q3=Blackveil Cape", "=ds=#s4#", "15.98%" },
		{ 11626, "INV_Misc_Cape_18", "=q2=Blackveil Cape", "=ds=#s4#", "15.98%" },
		--Changed in 1.10 { 11624, "INV_Shoulder_25", "=q3=Kentic Amice", "=ds=#s3#, #a1#", "22.45%" },
		{ 11624, "INV_Shoulder_25", "=q2=Kentic Amice", "=ds=#s3#, #a1#", "22.45%" },
		--Added in 1.10 { 22240, "INV_Boots_Chain_04", "=q3=Greaves of Withering Despair", "=ds=#s12#, #a3#", "16.81%" },
	...
	BRDAnubshiah = {
		...
		--Changed in 1.10 { 11677, "INV_Misc_Cape_19", "=q3=Graverot Cape", "=ds=#s4#", "23.07%" },
		{ 11677, "INV_Misc_Cape_19", "=q2=Graverot Cape", "=ds=#s4#", "23.07%" },
		--Changed in 1.10 { 11675, "INV_Boots_01", "=q3=Shadefiend Boots", "=ds=#s12#, #a2#", "25.84%" },
		{ 11675, "INV_Boots_01", "=q2=Shadefiend Boots", "=ds=#s12#, #a2#", "25.84%" },
	...
	BRDGorosh = {
		...
		--Added in 1.10 --Added in 1.10 --Added in 1.10 { 22271, "INV_Pants_Leather_21", "=q3=Leggings of Frenzied Magic", "=ds=#s11#, #a2#", "23.24%" },
		--Added in 1.10 --Added in 1.10 { 22257, "INV_Jewelry_Ring_36", "=q3=Bloodclot Band", "=ds=#s13#", "26.28%" },
		--Added in 1.10 { 22266, "INV_Spear_01", "=q3=Flarethorn", "=ds=#h1#, #w4#", "17.98%" },
	};
	BRDGrizzle = {
		...
		--Added in 1.10 { 22270, "INV_Boots_Plate_02", "=q3=Entrenching Boots", "=ds=#s12#, #a4#", "11.97%" },
		{ 11702, "INV_Axe_12", "=q3=Grizzle's Skinner", "=ds=#h3#, #w1#", "20.62%" },
	};
	BRDHedrum = {
		{ 11729, "INV_Helmet_01", "=q3=Savage Gladiator Helm", "=ds=#s1#, #a3#", "10.08%" },
		--Changed in 1.10 { 11633, "INV_Chest_Plate02", "=q3=Spiderfang Carapace", "=ds=#s5#, #a4#", "20.61%" },
		{ 11633, "INV_Chest_Plate02", "=q2=Spiderfang Carapace", "=ds=#s5#, #a4#", "20.61%" },
		--Changed in 1.10 { 11634, "INV_Gauntlets_12", "=q3=Silkweb Gloves", "=ds=#s9#, #a1#", "24.02%" },
		{ 11634, "INV_Gauntlets_12", "=q2=Silkweb Gloves", "=ds=#s9#, #a1#", "24.02%" },
		{ 11635, "INV_Weapon_ShortBlade_10", "=q3=Hookfang Shanker", "=ds=#h1#, #w4#", "17.26%" },
	};
	BRDOkthor = {
		--Changed in 1.10 { 11665, "INV_Gauntlets_15", "=q3=Ogreseer Fists", "=ds=#s9#, #a2#", "28.16%" },
		{ 11665, "INV_Gauntlets_15", "=q2=Ogreseer Fists", "=ds=#s9#, #a2#", "28.16%" },
		--Changed in 1.10 { 11662, "INV_Belt_29", "=q3=Ban'thok Sash", "=ds=#s10#, #a1#", "23.77%" },
		{ 11662, "INV_Belt_29", "=q2=Ban'thok Sash", "=ds=#s10#, #a1#", "23.77%" },
	...
	BRDHoundmaster = {
		--Changed in 1.10 { 11623, "INV_Misc_Cape_20", "=q3=Spritecaster Cape", "=ds=#s4#", "32.09%" },
		{ 11623, "INV_Misc_Cape_20", "=q2=Spritecaster Cape", "=ds=#s4#", "32.09%" },
		--Changed in 1.10 { 11627, "INV_Boots_01", "=q3=Fleetfoot Greaves", "=ds=#s12#, #a3#", "32.09%" },
		{ 11627, "INV_Boots_01", "=q2=Fleetfoot Greaves", "=ds=#s12#, #a3#", "32.09%" },
	...
	BRDTheVault = {
		-- IMPORTANT 1.10: SEE NORMAL ATLASLOOT TO RESTORE CORRECT FUNCTIONALITY
		{ 0, "INV_Box_01", "=q6=#j18#", "" },
		{ 11197, "INV_Misc_Key_11", "=q1=Dark Keeper Key", "=ds=#e14#", "100%" },
		{ 0, "", "", "" },
		--Added in 1.10 { 0, "INV_Box_01", "=q6=#cb19#", "" },
		--Added in 1.10 { 22256, "INV_Gauntlets_17", "=q3=Mana Shaping Handwraps", "=ds=#s9#, #a1#", "4.49%" },
		--Added in 1.10 { 22205, "INV_Bracer_14", "=q3=Black Steel Bindings", "=ds=#s8#, #a4#", "4.24%" },
		--Added in 1.10 { 22255, "INV_Jewelry_Ring_04", "=q3=Magma Forged Band", "=ds=#s13#", "4.02%" },
		--Added in 1.10 { 22254, "INV_Wand_02", "=q3=Wand of Eternal Light", "=ds=#w12#", "3.65%" },
	...
	BRDWarderStilgiss = {
		...
		--Added in 1.10 { 22241, "INV_Shoulder_07", "=q3=Dark Warder's Pauldrons", "=ds=#s3#, #a2#", "18.38%" },
	...
	BRDVerek =		{ 
		...
		--Added in 1.10 { 22242, "INV_Belt_18", "=q3=Verek's Leash", "=ds=#s10#, #a3#", "13.16%" },
	};
	BRDFineousDarkvire = {
		{ 11839, "INV_Helmet_44", "=q3=Chief Architect's Monocle", "=ds=#s1#, #a1#", "15.28%" },
		--Added in 1.10 { 22223, "INV_Helmet_20", "=q3=Foreman's Head Protector", "=ds=#s1#, #a4#", "19.73%" },
		--Changed in 1.10 { 11842, "INV_Shoulder_15", "=q3=Lead Surveyor's Mantle", "=ds=#s3#, #a3#", "20.83%" },
		{ 11842, "INV_Shoulder_15", "=q2=Lead Surveyor's Mantle", "=ds=#s3#, #a3#", "20.83%" },
		--Changed in 1.10 { 11841, "INV_Pants_09", "=q3=Senior Designer's Pantaloons", "=ds=#s11#, #a1#", "21.25%" },
		{ 11841, "INV_Pants_09", "=q2=Senior Designer's Pantaloons", "=ds=#s11#, #a1#", "21.25%" },
		{ 0, "", "", "" },
	...
	BRDLordIncendius = {
		...
		--{ 0, "", "", "" },
		--Added in 1.6 { 19268, "INV_Misc_Ticket_Tarot_Elemental_01", "=q3=Ace of Elementals", "=ds=#e19#", "2.10%" },
		{ 0, "", "", "" },
		{ 11768, "INV_Bracer_10", "=q2=Incendic Bracers", "=ds=#s8#, #a1#", "1.30%" },
	};
	BRDBaelGar = {
		{ 11807, "INV_Belt_11", "=q3=Sash of the Burning Heart", "=ds=#s10#, #a1#", "13.59%" },
		--Changed in 1.10 { 11802, "INV_Pants_04", "=q3=Lavacrest Leggings", "=ds=#s11#, #a4#", "26.75%" },
		{ 11802, "INV_Pants_04", "=q2=Lavacrest Leggings", "=ds=#s11#, #a4#", "26.75%" },
		{ 11805, "INV_Hammer_09", "=q3=Rubidium Hammer", "=ds=#h3#, #w6#", "17.02%" },
		--Changed in 1.10 { 11803, "INV_Hammer_09", "=q3=Force of Magma", "=ds=#h2#, #w6#", "27.47%" },
		{ 11803, "INV_Hammer_09", "=q2=Force of Magma", "=ds=#h2#, #w6#", "27.47%" },
	};
	BRDGeneralAngerforge = {
		--Changed in 1.10 { 11820, "INV_Chest_Plate04", "=q3=Royal Decorated Armor", "=ds=#s5#, #a3#", "18.55%" },
		{ 11820, "INV_Chest_Plate04", "=q2=Royal Decorated Armor", "=ds=#s5#, #a3#", "18.55%" },
		{ 11821, "INV_Pants_09", "=q3=Warstrife Leggings", "=ds=#s11#, #a2#", "16.41%" },
		--Added in 1.10 { 11810, "INV_Jewelry_Amulet_01", "=q3=Force of Will", "=ds=#s14#", "12.97%" },
		{ 11815, "INV_Jewelry_Talisman_01", "=q3=Hand of Justice", "=ds=#s14#", "10.43%" },
		{ 11817, "INV_Sword_25", "=q3=Lord General's Sword", "=ds=#h3#, #w10# ", "14.72%" },
		--Changed in 1.10 { 11816, "INV_Weapon_Halberd_06", "=q3=Angerforge's Battle Axe", "=ds=#h2#, #w1#", "16.41%" },
		{ 11816, "INV_Weapon_Halberd_06", "=q2=Angerforge's Battle Axe", "=ds=#h2#, #w1#", "16.41%" },
	};
	BRDGolemLordArgelmach = {
		--Changed in 1.10 { 11823, "INV_Pants_13", "=q3=Luminary Kilt", "=ds=#s11#, #a2#", "25.73%" },
		{ 11823, "INV_Pants_13", "=q2=Luminary Kilt", "=ds=#s11#, #a2#", "25.73%" },
		--Changed in 1.10 { 11822, "INV_Boots_05", "=q3=Omnicast Boots", "=ds=#s12#, #a1#", "26.73%" },
		{ 11822, "INV_Boots_05", "=q2=Omnicast Boots", "=ds=#s12#, #a1#", "26.73%" },
		{ 11669, "INV_Jewelry_Ring_05", "=q3=Naglering", "=ds=#s13#", "22.92%" },
		{ 11819, "INV_Jewelry_Talisman_06", "=q3=Second Wind", "=ds=#s14#", "5.75%" },
	};
	BRDGuzzler = {
		{ 0, "INV_Box_01", "=q6=#x98#", "" },
		{ 11735, "INV_Helmet_46", "=q3=Ragefury Ey", "=ds=#s1#, #a2#", "8.11%" },
		--Added in 1.10 { 18043, "INV_Boots_08", "=q3=Coal Miner Boots", "=ds=#s12#, #a2#", "23.87%" },
		--Added in 1.10 { 22275, "INV_Boots_08", "=q3=Firemoss Boots", "=ds=#s12#, #a2#", "23.87%" },
		--Added in 1.10 { 18044, "INV_Drink_04", "=q3=Hurley's Tankard", "=ds=#h3#, #w6#", "31.02%" },
		{ 0, "", "", "" },
		{ 0, "INV_Box_01", "=q6=#x97#", "" },
		--Added in 1.10 { 22212, "INV_Shoulder_16", "=q3=Golem Fitted Pauldrons", "=ds=#s3#, #a3#", "26.04%" },
		{ 11745, "INV_Gauntlets_22", "=q3=Fists of Phalanx", "=ds=#s9#, #a4#", "29.79%" },
		{ 11744, "INV_Gauntlets_11", "=q3=Bloodfist", "=ds=#h1#, #w13#", "28.48%" },
		{ 0, "", "", "" },
		--Added in 1.4 { 0, "INV_Box_01", "=q6=#x96#", "=q6=#m4#" },
		--Added in 1.4 { 18592, "INV_Scroll_03", "=q4=Plans: Sulfuron Hammer", "=ds=#p2# (300)" },
		--Added in 1.4 { 17193, "INV_Hammer_Unique_Sulfuras", "=q4=Sulfuron Hammer", "=ds=#h2#, #w6#" },
		--Added in 1.4 { 0, "", "", "" },
		{ 0, "INV_Box_01", "=q6=#x95#", "" },
		...
		--Added in 1.4 { 18653, "INV_Scroll_06", "=q2=Schematic: Goblin Jumper Cables XL", "=ds=#p5# (265)", "14.31%" },
	...
	BRDFlamelash = {
		...
		{ 0,"","","" },
		--Added in 1.11 { 23320, "INV_Misc_StoneTablet_11", "=q3=Tablet of Flame Shock VI", "=ds=#e20# =q15=#c7#", "8.71%" },
	};
	BRDPanzor = {
		--Added in 1.10 { 22245, "INV_Boots_Cloth_05", "=q3=Soot Encrusted Footwear", "=ds=#s12#,#a1#", "22.06%" },
	...
	BRDMagmus = {
		...
		--Added in 1.10 { 22395, "INV_Relics_TotemofRage", "=q3=Totem of Rage", "=ds=#s16#, #e17# =q15=#c7#", "10.09%" },
		--Added in 1.10 { 22400, "INV_Relics_LibramofTruth", "=q3=Libram of Truth", "=ds=#s16#, #e18# =q16=#c4#", "9.75%" },
		--Added in 1.10 { 22208, "INV_Hammer_10", "=q3=Lavastone Hammer", "=ds=#h2#, #w6#", "22.79%" },
	};
	BRDEmperorDagranThaurissan = {
		...
		--Added in 1.10 { 22204, "INV_Bracer_10", "=q3=Wristguards of Renown", "=ds=#s8#, #a2#", "12.92%" },
		--Added in 1.10 { 22207, "INV_Belt_28", "=q3=Sash of the Grand Hunt", "=ds=#s10#, #a3#", "15.12%" },
		{ 11934, "INV_Jewelry_Ring_24", "=q3=Emperor's Seal", "=ds=#s13# =q2=#e23#", "15.41%" },
		--Added in 1.10 { 11815, "INV_Jewelry_Talisman_01", "Hand of Justice", "=ds=#s14#", "10.43%" },
	...
	BRDTrash = {
		...
		--Added in 1.4 { 18654, "INV_Scroll_06", "=q2=Schematic: Gnomish Alarm-O-Bot", "=ds=#p5# (265) =q7=#x47#", "1.88%" },
		--Added in 1.4 { 18661, "INV_Scroll_06", "=q2=Schematic: World Enlarger", "=ds=#p5# (260) =q7=#x47#", "2.00%" },
		--Added in 1.3 { 0, "", "", "" },	
		--Added in 1.3 { 18232, "INV_Egg_05", "=q1=Field Repair Bot 74A", "=ds=#p5# (300) =q7=#m22#" },
		{ 0, "", "", "" },	
	...
	UBRSEmberseer = {
		...
		--Changed in 1.10 { 12905,"INV_Chest_Cloth_16","=q3=Wildfire Cape", "=ds=#s4#", "15.20%" },
		{ 12905,"INV_Chest_Cloth_16","=q2=Wildfire Cape", "=ds=#s4#", "15.20%" },
		--Changed in 1.10 { 12926,"Spell_Holy_InnerFire","=q3=Flaming Band", "=ds=#s13# =q2=#e23#", "18.52%" },
		{ 12926,"Spell_Holy_InnerFire","=q2=Flaming Band", "=ds=#s13# =q2=#e23#", "18.52%" },
		{ 0,"","","" },
		--Added in 1.11 { 23320,"INV_Misc_StoneTablet_11","=q3=Tablet of Flame Shock VI","=ds=#e20# =q15=#c7#", "8.23%" },
	};
	UBRSRunewatcher = {
	...
	UBRSSolakar = {
		...
		--Added in 1.4 { 0,"","","" },
		--Added in 1.4 { 18657, "INV_Scroll_06", "=q2=Schematic: Hyper-Radiant Flame Reflector", "=ds=#p5# (290)", "7.38%" },
		--Added in 1.4 { 18638, "INV_Misc_EngGizmos_04", "=q3=Hyper-Radiant Flame Reflector", "=ds=#s14#" },
	};
	UBRSFlame = {
	...
	UBRSAnvilcrack = {
		...
		--Changed in 1.10 { 13498,"INV_Pants_04","=q3=Handcrafted Mastersmith Leggings", "=ds=#s11#, #a4#", "20.63%" },
		{ 13498,"INV_Pants_04","=q2=Handcrafted Mastersmith Leggings", "=ds=#s11#, #a4#", "20.63%" },
		--Added in 1.3 { 18047,"INV_Boots_02","=q3=Flame Walkers", 	"=ds=#s12#, #a3#", "18.05%" },
		--Changed in 1.10 { 18048,"INV_Hammer_06","=q3=Mastersmith's Hammer", "=ds=#h3#, #w6#", "17.26%" },
		--Added in 1.3 { 18048,"INV_Hammer_06","=q2=Mastersmith's Hammer", "=ds=#h3#, #w6#", "17.26%" },
		{ 0,"","","" },
		...
		--Added in 1.4 { 0,"","","" },
		--Added in 1.4 { 18779,"INV_Misc_Note_06","=q3=Bottom Half of Advanced Armorsmithing: Volume I","=ds=#m8#", "17.08%" },
		--Added in 1.4 { 12727, "INV_Scroll_05", "=q3=Plans: Enchanted Thorium Breastplate", "=q1=#m4# =ds=#p2# (300)" },
		--Added in 1.4 { 12618, "INV_Chest_Plate10", "=q3=Enchanted Thorium Breastplate", "=ds=#s5#, #a4#" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "INV_Box_01", "=q6=#cb4#", "" },
	...
	UBRSRend = {
		...
		--Added in 1.3 { 18104,"INV_Belt_03","=q3=Feralsurge Girdle","=ds=#s10#, #a3#", "15.30%" },
		{ 12935,"INV_Pants_04","=q3=Warmaster Legguards","=ds=#s11#, #a4#", "15.05%" },
		--Added in 1.3 { 18102,"INV_Boots_05","=q3=Dragonrider Boots","=ds=#s12#, #a1#", "14.35%" },
		--Added in 1.10 { 22247,"INV_Boots_Cloth_03","=q3=Faith Healer's Boots","=ds=#s12#, #a1#", "12.71%" },
		--Added in 1.3 { 18103,"INV_Jewelry_Ring_16","=q3=Band of Rumination","=ds=#s13#", "15.38%" },
	...
	UBRSGyth = {
		...
		{ 0,"","","" },
		--Added in 1.10 { 22225,"INV_Helmet_27","=q3=Dragonskin Cowl","=ds=#s1#, #a1# =q2=#e24#", "11.85%" },
		--Changed in 1.10 { 12960,"INV_Helmet_24","=q3=Tribal War Feathers","=ds=#s1#, #a2# =q2=#e24#", "15.24%" },
		{ 12960,"INV_Helmet_24","=q2=Tribal War Feathers","=ds=#s1#, #a2# =q2=#e24#", "15.24%" },
		--Changed in 1.10 { 12953,"INV_Helmet_39","=q3=Dragoneye Coif","=ds=#s1#, #a3# =q2=#e24#", "15.99%" },
		{ 12953,"INV_Helmet_39","=q2=Dragoneye Coif","=ds=#s1#, #a3# =q2=#e24#", "15.99%" },
		--Changed in 1.10 { 12952,"INV_Helmet_23","=q3=Gyth's Skull","=ds=#s1#, #a4# =q2=#e24#", "12.43%" },
		{ 12952,"INV_Helmet_23","=q2=Skull of Gyth","=ds=#s1#, #a4# =q2=#e24#", "12.43%" },
		{ 0,"","","" },
	...
	UBRSBeast = {
		...
		--Added in 1.10 { 22311,"INV_Boots_Cloth_05","=q3=Ironweave Boots", "=ds=#s12#, #a1# =q9=#c5#=ds=, =q10=#c3#=ds=, =q11=#c8#", "12.31%" },
		{ 12709,"INV_Sword_33","=q3=Finkle's Skinner", "=ds=#h3#, #w4#", "6.95%" },
		{ 12969,"INV_Hammer_17","=q3=Seeping Willow", "=ds=#h2#, #w6#", "11.49%" },
		--{ 0,"","","" },
		--Added in 1.12 { 24101, "INV_Misc_Book_02", "=q3=Book of Ferocious Bite V", "=ds=#e20# =q13=#c1#", "1.44%" },
		--Added in 1.6 { 19227, "INV_Misc_Ticket_Tarot_Beasts_01", "=q3=Ace of Beasts", "=ds=#e19#", "4.53%" },
	};
	UBRSValthalak = {
	...
	UBRSDrakkisath = {
		...
		{ 0,"","","" },
		--Added in 1.10 { 22267,"INV_Helmet_62","=q3=Spellweaver's Turban", "=ds=#s1#, #a1#", "15.50%" },
		{ 13141,"INV_Jewelry_Necklace_09","=q3=Tooth of Gnarr", "=ds=#s2#", "16.83%" },
		--Added in 1.10 { 22269,"INV_Misc_Cape_20","=q3=Shadow Prowler's Cloak", "=ds=#s4#", "10.61%" },
		{ 13142,"INV_Belt_33","=q3=Brigam Girdle", "=ds=#s10#, #a4#", "16.40%" },
		{ 13098,"INV_Jewelry_Ring_18","=q3=Painweaver Band", "=ds=#s13#", "13.51%" },
		--Added in 1.10 { 22268,"INV_Jewelry_Talisman_09","=q3=Draconic Infused Emblem", "=ds=#s14#", "4.13%" },
		--Added in 1.10 { 22253,"INV_Misc_Book_06","=q3=Tome of the Lost", "=ds=#s15#", "16.05%" },
	...
	UBRSTrash = {
		--Added in 1.12 { 24102, "INV_Misc_Book_14", "=q3=Manual of Eviscerate IX", "=ds=#e20# =q12=#c6# =q7=#x60#", "0.94%" },
	...
	STRATCrimsonHammersmith = {
		--Added in 1.4 { 18781, "INV_Misc_Note_03", "=q3=Bottom Half of Advanced Armorsmithing: Volume II", "=ds=#m8#", "41.6%" },
		--Added in 1.4 { 12726, "INV_Scroll_05", "=q3=Plans: Enchanted Thorium Leggings", "=q1=#m4# =ds=#p2# (300)" },
		--Added in 1.4 { 12619, "INV_Pants_04", "=q3=Enchanted Thorium Leggings", "=ds=#s11#, #a4#" },
		--Added in 1.4 { 0,"","","" },
	...
	STRATCannonMasterWilley = {
		...
		{ 0, "", "", "", "" },
		--Added in 1.10 { 22407, "INV_Helmet_41", "=q3=Helm of the New Moon", "=ds=#s1#, #a2#", "13.61%" },
		--Added in 1.10 { 22403, "INV_Jewelry_Necklace_10", "=q3=Diana's Pearl Necklace", "=ds=#s2#", "14.27%" },
		--Added in 1.10 { 22405, "INV_Shoulder_02", "=q3=Mantle of the Scarlet Crusade", "=ds=#s3#, #a1#", "16.03%" },
		--Added in 1.4 { 18721, "INV_Belt_18", "=q3=Barrage Girdle", "=ds=#s10#, #a3#", "12.39%" },
		...
		--Added in 1.10 { 22404, "INV_Weapon_ShortBlade_16", "=q3=Willey's Back Scratcher", "=ds=#h3#, #w13#", "6.26%" },
		--Added in 1.10 { 22406, "INV_Staff_23", "=q3=Redemption", "=ds=#w9#", "7.04%" },
		{ 0, "", "", "", "" },
	...
	STRATArchivistGalford = {
		...
		{ 0, "", "", "", "" },
		--Changed in 1.4 { 13386, "INV_Misc_Cape_19", "=q3=Archivist Cape", "=ds=#s4# =q2=#e23#", "18.45%" },
		{ 13386, "INV_Misc_Cape_19", "=q2=Archivist Cape", "=ds=#s4# =q2=#e23#", "18.45%" },
		{ 13387, "INV_Belt_21", "=q3=Foresight Girdle", "=ds=#s10#, #a3# =q2=#e23#", "18.24%" },
		--Added in 1.4 { 18716, "INV_Boots_08", "=q3=Ash Covered Boots", "=ds=#s12#, #a2#", "16.30%" },
		{ 13385, "INV_Misc_Book_05", "=q3=Tome of Knowledge", "=ds=#s15#", "9.87%" },
		{ 0, "", "", "", "" },
		--Changed in 1.3 { 12811, "INV_Misc_Gem_Pearl_03", "=q2=Righteous Orb", "=ds=#e12#", "45.41%" },
		{ 12811, "INV_Misc_Gem_Pearl_03", "=q1=Righteous Orb", "=ds=#e12#", "45.41%" },
		{ 0, "", "", "", "" },
		-- Added in 1.9 { 22897, "INV_Misc_Book_07", "=q1=Tome of Conjure Food VII", "=ds=#e20# =q10=#c3#", "4.86%" },
	};
	STRATBalnazzar = {
		...
		--Added in 1.4 { 18718, "INV_Helmet_10", "=q3=Grand Crusader's Helm", "=ds=#s1#, #a4#", "10.16%" },
		{ 12103, "INV_Jewelry_Talisman_08", "=q3=Star of Mystaria", "=ds=#s2#", "12.48%" },
		--Added in 1.4 { 18720, "INV_Shoulder_23", "=q3=Shroud of the Nathrezim", "=ds=#s3#, #a1#", "10.54%" },
		...
		--Added in 1.4 { 18717, "INV_Hammer_06", "=q3=Hammer of the Grand Crusader", "=ds=#h2#, #w6#", "11.91%" },
	...
	STRATBaronessAnastari = {
		...
		{ 0, "", "", "", "" },
		--Added in 1.4 { 18728, "INV_Jewelry_Necklace_11", "=q3=Anastari Heirloom", "=ds=#s2#", "11.92%" },
		--Added in 1.4 { 18730, "INV_Gauntlets_16", "=q3=Shadowy Laced Handwraps", "=ds=#s9#, #a1#", "13.54%" },
		--Added in 1.4 { 18729, "INV_Weapon_Bow_12", "=q3=Screeching Bow", "=ds=#w2#", "15.59%" },
	...
	STRATBlackGuardSwordsmith = {
		--Added in 1.4 { 18783, "INV_Misc_Note_04", "=q3=Bottom Half of Advanced Armorsmithing: Volume III", "=ds=#m8#", "23.5%" },
		--Added in 1.4 { 12725, "INV_Scroll_05", "=q3=Plans: Enchanted Thorium Helm", "=q1=#m4# =ds=#p2# (300)" },
		--Added in 1.4 { 12620, "INV_Helmet_02", "=q3=Enchanted Thorium Helm", "=ds=#s1#, #a4#" },
		--Added in 1.4 { 0,"","","" },
	...
	STRATNerubenkan = {
		...
		{ 0, "", "", "", "" },
		--Added in 1.4 { 18740, "INV_Belt_13", "=q3=Thuzadin Sash", "=ds=#s10#, #a1#", "14.72%" },
		--Added in 1.4 { 18739, "INV_Pants_04", "=q3=Chitinous Plate Legguards", "=ds=#s11#, #a4#", "12.19%" },
		--Added in 1.4 { 18738, "INV_Weapon_Crossbow_04", "=q3=Carapace Spine Crossbow", "=ds=#w3#", "14.17%" },
	...
	STRATMalekithePallid = {
		...
		{ 0, "", "", "", "" },
		--Added in 1.4 { 18734, "INV_Misc_Cape_11", "=q3=Pale Moon Cloak", "=ds=#s4#", "13.42%" },
		--Added in 1.4 { 18735, "INV_Boots_03", "=q3=Maleki's Footwraps", "=ds=#s12#, #a1#", "15.03%" },
		{ 13524, "INV_Misc_Bone_HumanSkull_01", "=q3=Skull of Burning Shadows", "=ds=#s15#", "13.42%" },
		--Added in 1.4 { 18737, "INV_Axe_11", "=q3=Bone Slicing Hatchet", "=ds=#h1#, #w1#", "14.23%" },
		{ 0, "", "", "", "" },
	...
	STRATMagistrateBarthilas = {
		--Added in 1.4 { 18727, "INV_Helmet_51", "=q3=Crimson Felt Hat", "=ds=#s1#, #a1#", "13.82%" },
		{ 13376, "INV_Misc_Cape_14", "=q3=Royal Tribunal Cloak", "=ds=#s4#", "12.44%" },
		--Added in 1.4 { 18726, "INV_Bracer_11", "=q3=Magistrate's Cuffs", "=ds=#s8#, #a2#", "12.87%" },
		--Added in 1.4 { 18722, "INV_Gauntlets_13", "=q3=Death Grips", "=ds=#s9#, #a4#", "15.34%" },
		--Added in 1.11 { 23198, "INV_Relics_IdolofFerocity", "=q3=Idol of Brutality", "=ds=#s16#, #e16# =q13=#c1#", "2.37%" },
		--Added in 1.4 { 18725, "INV_Spear_07", "=q3=Peacemaker", "=ds=#w7#", "14.22%" },
		{ 0, "", "", "", "" },
		--Changed in 1.7 { 12382, "INV_Misc_Key_13", "=q2=Key to the City", "=ds=#e14#", "100%" },
		{ 12382, "INV_Misc_Key_13", "=q1=Key to the City", "=ds=#e14#", "100%" },
	};
	STRATRamsteintheGorger = {
		{ 16737, "INV_Gauntlets_26", "=q3=Gauntlets of Valor", "=ds=#s9#, #a4# (Т0, =q17=#c9#=ds=)", "9.58%" },
		{ 0, "", "", "", "" },
		--Added in 1.4 { 18723, "INV_Jewelry_Necklace_01", "=q3=Animated Chain Necklace", "=ds=#s2#", "7.54%" },
	...
	STRATBaronRivendare = {
		...
		{ 0, "", "", "", "" },
		--Added in 1.10 { 22411, "INV_Helmet_01", "=q3=Helm of the Executioner", "=ds=#s1#, #a4#", "3.80%" },
		--Added in 1.10 { 22412, "INV_Shoulder_02", "=q3=Thuzadin Mantle", "=ds=#s3#, #a1#", "4.16%" },
		...
		--Added in 1.10 { 22409, "INV_Chest_Leather_08", "=q3=Tunic of the Crescent Moon", "=ds=#s5#, #a2#", "4.59%" },
		{ 13344, "INV_Gauntlets_31", "=q3=Dracorian Gauntlets", "=ds=#s9#, #a3#", "10.85%" },
		--Added in 1.10 { 22410, "INV_Gauntlets_11", "=q3=Gauntlets of Deftness", "=ds=#s9#, #a3#", "4.98%" },
		{ 13345, "INV_Jewelry_Ring_16", "=q3=Seal of Rivendare", "=ds=#s13#", "9.50%" },
		--Added in 1.10 { 22408, "INV_Wand_07", "=q3=Ritssyn's Wand of Bad Mojo", "=ds=#w12#", "3.39%" },
	...
	STRATTrash = {
		...
		--Changed in 1.3 { 12811, "INV_Misc_Gem_Pearl_03", "=q2=Righteous Orb", "=ds=#e12#", "45.41%" },
		{ 12811, "INV_Misc_Gem_Pearl_03", "=q1=Righteous Orb", "=ds=#e12#", "45.41%" },
		--Changed in 1.4 { 12735, "INV_Misc_Pelt_Boar_Ruin_03", "=q2=Frayed Abomination Stitching", "=ds=#m27#", "17.5%" },
		{ 12735, "INV_Misc_Pelt_Boar_Ruin_03", "=q1=Frayed Abomination Stitching", "=ds=#m27#", "17.5%" },
		...
		--Changed in 1.4 { 18742, "INV_Shoulder_14", "=q3=Stratholme Militia Shoulderguard", "=ds=#s3#, #a3#", "0.01%" },
		--Changed in 1.4 { 18743, "INV_Misc_Cape_18", "=q3=Gracious Cape", "=ds=#s4#", "0.01%" },
		--Added in 1.10 { 17061, "INV_Misc_Cape_20", "=q3=Juno's Shadow", "=ds=#s4#", "0.01%" },
		--Changed in 1.4 { 18741, "INV_Bracer_17", "=q3=Morlune's Bracer", "=ds=#s8#, #a4#", "0.01%" },
		--Changed in 1.4 { 18744, "INV_Gauntlets_18", "=q3=Plaguebat Fur Gloves", "=ds=#s9#, #a2#", "0.01%" },
		--Changed in 1.4 { 18745, "INV_Pants_01", "=q3=Sacred Cloth Leggings", "=ds=#s11#, #a1#", "0.01%" },
		--Changed in 1.4 { 18736, "INV_Pants_12", "=q3=Plaguehound Leggings", "=ds=#s11#, #a2#", "0.01%" },
		--Changed in 1.4 { 0,"","","" },
		...
		--Added in 1.4 { 18658, "INV_Scroll_06", "=q2=Schematic: Ultra-Flash Shadow Reflector", "=ds=#p5# (300) =q7=#x77#", "1.82%" },
	...
	LBRSOmokk = {
		...
		{ 0, "", "", "", "" },
		--Changed in 1.3 { 12336, "INV_Misc_Gem_Diamond_02", "=q2=Gemstone of Spirestone", "=ds=#m8#", "15.72%" },
		{ 12336, "INV_Misc_Gem_Diamond_02", "=q1=Gemstone of Spirestone", "=ds=#m8#", "15.72%" },
		{ 0, "", "", "", "" },
		{ 12534, "INV_Misc_Head_Centaur_01", "=q1=Omokk's Head", "=ds=#m8#", "100.00%" },
	};
	LBRSSpirestoneBattleLord = {
		--Changed in 1.10 { 13284, "INV_Boots_01", "=q3=Swiftdart Battleboots", "=ds=#s12#, #a3#", "48.68%" },
		{ 13284, "INV_Boots_01", "=q2=Swiftdart Battleboots", "=ds=#s12#, #a3#", "48.68%" },
	...
	LBRSVosh = {
		...
		--Changed in 1.10 { 13255, "INV_Gauntlets_30", "=q3=Trueaim Gauntlets", "=ds=#s9#, #a3#", "18.08%" },
		{ 13255, "INV_Gauntlets_30", "=q2=Trueaim Gauntlets", "=ds=#s9#, #a3#", "18.08%" },
	...
	LBRSVoone = {
		...
		{ 0, "", "", "", "" },
		--Changed in 1.10 { 13177, "INV_Jewelry_Amulet_04", "=q3=Talisman of Evasion", "=ds=#s2#", "15.40%" },
		{ 13177, "INV_Jewelry_Amulet_04", "=q2=Talisman of Evasion", "=ds=#s2#", "15.40%" },
		{ 13179, "INV_Bracer_09", "=q3=Brazecore Armguards", "=ds=#s8#, #a3#", "16.12%" },
		--Added in 1.10 { 22231, "INV_Boots_Cloth_02", "=q3=Kayser's Boots of Precision", "=ds=#s12#, #a1#", "15.40%" },
		...
		{ 0, "", "", "", "" },
		--Changed in 1.3 { 12335, "INV_Misc_Gem_Opal_01", "=q2=Gemstone of Smolderthorn", "=ds=#m8#", "21.43%" },
		{ 12335, "INV_Misc_Gem_Opal_01", "=q1=Gemstone of Smolderthorn", "=ds=#m8#", "21.43%" },
	};
	LBRSGrayhoof = {
	...
	LBRSSmolderweb = {
		...
		{ 0, "", "", "", "" },
		--Changed in 1.10 { 13244, "INV_Gauntlets_29", "=q3=Gilded Gauntlets", "=ds=#s9#, #a3#", "25.06%" },
		{ 13244, "INV_Gauntlets_29", "=q2=Gilded Gauntlets", "=ds=#s9#, #a3#", "25.06%" },
	...
	LBRSDoomhowl = {
		...
		--Added in 1.10 { 22232, "INV_Belt_18", "=q3=Marksman's Girdle", "=ds=#s10#, #a3#", "20.60%" },
		{ 13259, "INV_Boots_Plate_08", "=q3=Ribsteel Footguards", "=ds=#s12#, #a4#", "25.38%" },
		{ 13178, "INV_Jewelry_Ring_22", "=q3=Rosewine Circle", "=ds=#s13#", "21.48%" },
		--Added in 1.4 { 0, "", "", "" },
		--Added in 1.4 { 18784, "INV_Misc_Note_04", "=q3=Top Half of Advanced Armorsmithing: Volume III", "=ds=#m9#", "10.30%" },
		--Added in 1.4 { 12725, "INV_Scroll_05", "=q3=Plans: Enchanted Thorium Helm", "=q1=#m4# =ds=#p2# (300)" },
		--Added in 1.4 { 12620, "INV_Helmet_02", "=q3=Enchanted Thorium Helm", "=ds=#s1#, #a4#" },
	};
	LBRSZigris = {
	...
	LBRSHalycon = {
		--Changed in 1.10 { 13212, "INV_Belt_14", "=q3=Halycon's Spiked Collar", "=ds=#s2#", "18.23%" },
		{ 13212, "INV_Belt_14", "=q2=Halycon's Spiked Collar", "=ds=#s2#", "18.23%" },
		--Added in 1.10 { 22313, "INV_Bracer_13", "=q3=Ironweave Bracers", "=ds=#s8#, #a1# =q9=#c5#=ds=, =q10=#c3#=ds=, =q11=#c8#", "18.16%" },
		--Changed in 1.10 { 13211, "INV_Bracer_07", "=q3=Slashclaw Bracers", "=ds=#s8#, #a3#", "20.32%" },
		{ 13211, "INV_Bracer_07", "=q2=Slashclaw Bracers", "=ds=#s8#, #a3#", "20.32%" },
	...
	LBRSWyrmthalak = {
		...
		--Added in 1.10 { 22321, "INV_Misc_Gem_Bloodstone_01", "=q3=Heart of Wyrmthalak", "=ds=#s14#", "13.87%" },
		...
		{ 0, "", "", "", "" },
		--Changed in 1.3 { 12337, "INV_Misc_Gem_Bloodstone_01", "=q2=Gemstone of Bloodaxe", "=ds=#m8#", "29.15%" },
		{ 12337, "INV_Misc_Gem_Bloodstone_01", "=q1=Gemstone of Bloodaxe", "=ds=#m8#", "29.15%" },
		{ 0, "", "", "", "" },
		{ 0, "", "", "", "" },
		{ 0, "", "", "", "" },
	...
	LBRSBashguud = {
		--Changed in 1.10 { 13203, "INV_Misc_Cape_19", "=q3=Armswake Cloak", "=ds=#s4#", "44.27%" },
		{ 13203, "INV_Misc_Cape_19", "=q2=Armswake Cloak", "=ds=#s4#", "44.27%" },
		{ 13198, "INV_Gauntlets_11", "=q3=Hurd Smasher", "=ds=#h1#, #w13#", "28.35%" },
		--Changed in 1.10 { 13204, "INV_Mace_15", "=q3=Bashguuder", "=ds=#h1#, #w6#", "40.54%" },
		{ 13204, "INV_Mace_15", "=q2=Bashguuder", "=ds=#h1#, #w6#", "40.54%" },
	};
	LBRSSpirestoneButcher = {
		--Changed in 1.10 { 12608, "INV_Misc_Cape_18", "=q3=Butcher's Apron", "=ds=#s4#", "54.31%" },
		{ 12608, "INV_Misc_Cape_18", "=q2=Butcher's Apron", "=ds=#s4#", "54.31%" },
		{ 13286, "INV_Pick_05", "=q3=Rivenspike", "=ds=#h1#, #w1#", "35.78%" },
	};
	LBRSSpirestoneLordMagus = {
		{ 13282, "INV_Boots_05", "=q3=Ogreseer Tower Boots", "=ds=#s12#, #a1#", "31.87%" },
		--Changed in 1.10 { 13283, "Spell_Holy_InnerFire", "=q3=Magus Ring", "=ds=#s13#", "32.18%" },
		{ 13283, "Spell_Holy_InnerFire", "=q2=Magus Ring", "=ds=#s13#", "32.18%" },
		{ 13261, "INV_Wand_09", "=q3=Globe of D'sak", "=ds=#s15#", "35.06%" },
	};
	LBRSFelguard = {
		{ 13181, "INV_Gauntlets_15", "=q3=Demonskin Gloves", "=ds=#s9#, #a1#", "14.47%" },
		--Changed in 1.10 { 13182, "INV_Sword_36", "=q3=Phase Blade", "=ds=#h1#, #w10#", "11.63%" },
		{ 13182, "INV_Sword_36", "=q2=Phase Blade", "=ds=#h1#, #w10#", "11.63%" },
	};
	LBRSTrash = {
	...
	SCHOLOJandiceBarov = {
		...
		{ 0, "", "", "", "" },
		--Changed in 1.10 { 14548, "INV_Shoulder_11", "=q3=Royal Cap Spaulders", "=ds=#s3#, #a3#", "10.06%" },
		{ 14548, "INV_Shoulder_11", "=q2=Royal Cap Spaulders", "=ds=#s3#, #a3#", "10.06%" },
		--Added in 1.4 { 18689, "INV_Misc_Cape_20", "=q3=Phantasmal Cloak", "=ds=#s4#", "7.52%" },
		--Changed in 1.10 { 14543, "INV_Gauntlets_15", "=q3=Darkshade Gloves", "=ds=#s9#, #a1#", "0.26%" },
		{ 14543, "INV_Gauntlets_15", "=q2=Darkshade Gloves", "=ds=#s9#, #a1#", "0.26%" },
		--Changed in 1.10 { 14545, "INV_Pants_11", "=q3=Ghostloom Leggings", "=ds=#s11#, #a2#", "8.81%" },
		{ 14545, "INV_Pants_11", "=q2=Ghostloom Leggings", "=ds=#s11#, #a2#", "8.81%" },
		--Added in 1.4 { 18690, "INV_Pants_04", "=q3=Wraithplate Leggings", "=ds=#s11#, #a4#", "8.59%" },
		{ 14541, "INV_Sword_03", "=q3=Barovian Family Sword", "=ds=#h2#, #w10#", "8.27%" },
		--Added in 1.10 { 22394, "INV_Staff_29", "=q3=Staff of Metanoia", "=ds=#w9#", "8.67%" },
		{ 0, "", "", "", "" },
		{ 0, "", "", "", "" },
		{ 13523, "INV_Potion_24", "=q1=Blood of Innocents", "=ds=#m8#", "100%" },
	};
	...
	SCHOLORattlegore = {
		...
		{ 0, "", "", "", "" },
		--Changed in 1.10 { 14539, "INV_Helmet_14", "=q3=Bone Ring Helm", "=ds=#s1#, #a2#", "10.89%" },
		{ 14539, "INV_Helmet_14", "=q2=Bone Ring Helm", "=ds=#s1#, #a2#", "10.89%" },
		--Changed in 1.10 { 14538, "INV_Shoulder_02", "=q3=Deadwalker Mantle", "=ds=#s3#, #a1#", "11.32%" },
		{ 14538, "INV_Shoulder_02", "=q2=Deadwalker Mantle", "=ds=#s3#, #a1#", "11.32%" },
		--Added in 1.4 { 18686, "INV_Shoulder_03", "=q3=Bone Golem Shoulders", "=ds=#s3#, #a3#", "9.04%" },
		--Changed in 1.10 { 14537, "INV_Boots_Plate_09", "=q3=Corpselight Greaves", "=ds=#s12#, #a4#", "10.22%" },
		{ 14537, "INV_Boots_Plate_09", "=q2=Corpselight Greaves", "=ds=#s12#, #a4#", "10.22%" },
		--Changed in 1.10 { 14528, "INV_Shield_02", "=q3=Rattlecage Buckler", "=ds=#w8#", "9.16%" },
		{ 14528, "INV_Shield_02", "=q2=Rattlecage Buckler", "=ds=#w8#", "9.16%" },
		{ 14531, "INV_Hammer_13", "=q3=Frightskull Shaft", "=ds=#h2#, #w6#", "9.55%" },
		--Added in 1.4 { 0, "", "", "", "" },
		--Added in 1.4 { 18782, "INV_Misc_Note_03", "=q3=Top Half of Advanced Armorsmithing: Volume II", "=ds=#m8#", "5.71%" },
		--Added in 1.4 { 12726, "INV_Scroll_05", "=q3=Plans: Enchanted Thorium Leggings", "=q1=#m4# =ds=#p2# (300)" },	
		--Added in 1.4 { 12619, "INV_Pants_04", "=q3=Enchanted Thorium Leggings", "=ds=#s11#, #a4#" },
		{ 0, "", "", "", "" },
	...
	SCHOLOVectus = {
		--Added in 1.4 { 18691, "INV_Jewelry_Necklace_06", "=q3=Dark Advisor's Pendant", "=ds=#s2#", "6.16%" },
		{ 14577, "INV_Pants_08", "=q3=Skullsmoke Pants", "=ds=#s11#, #a1#", "5.24%" },
	};
	SCHOLOMarduk = {
		--Added in 1.4 { 18692, "INV_Boots_Plate_08", "=q3=Death Knight Sabatons", "=ds=#s12#, #a4#", "6.29%" },
	...
	SCHOLORasFrostwhisper = {
		...
		--Added in 1.4 { 18693, "INV_Gauntlets_16", "=q3=Shivery Handwraps", "=ds=#s9#, #a1#", "12.38%" },
		...
		--Added in 1.4 { 18694, "INV_Boots_01", "=q3=Shadowy Mail Greaves", "=ds=#s12#, #a3#", "14.63%" },
		--Added in 1.4 { 18695, "INV_Misc_Book_06", "=q3=Spellbound Tome", "=ds=#s15#", "10.86%" },
		--Added in 1.4 { 18696, "INV_Shield_02", "=q3=Intricately Runed Shield", "=ds=#w8#", "13.04%" },
	...
	SCHOLOInstructorMalicia = {
		...
		{ 0, "", "", "", "" },
		{ 0, "", "", "", "" },
		--Added in 1.4 { 18681, "INV_Shoulder_05", "=q3=Burial Shawl", "=ds=#s3#, #a1#", "1.81%" },
		--Changed in 1.4 { 14633, "INV_Shoulder_02", "=q3=Necropile Mantle", "=ds=#s3#, #a1#", "1.12%" },
		{ 14633, "INV_Shoulder_02", "=q2=Necropile Mantle", "=ds=#s3#, #a1#", "1.12%" },
		...
		--Changed in 1.10 { 14629, "INV_Bracer_07", "=q3=Necropile Cuffs", "=ds=#s8#, #a1#", "1.03%" },
		{ 14629, "INV_Bracer_07", "=q2=Necropile Cuffs", "=ds=#s8#, #a1#", "1.03%" },
		--Changed in 1.10 { 14640, "INV_Gauntlets_15", "=q3=Cadaverous Gloves", "=ds=#s9#, #a2#", "0.82%" },
		{ 14640, "INV_Gauntlets_15", "=q2=Cadaverous Gloves", "=ds=#s9#, #a2#", "0.82%" },
		--Changed in 1.10 {{ 14615, "INV_Gauntlets_26", "=q3=Bloodmail Gauntlets", "=ds=#s9#, #a3#", "0.09%" },
		{ 14615, "INV_Gauntlets_26", "=q2=Bloodmail Gauntlets", "=ds=#s9#, #a3#", "0.09%" },
		--Changed in 1.10 { 14622, "INV_Gauntlets_28", "=q3=Deathbone Gauntlets", "=ds=#s9#, #a4#", "0.45%" },
		{ 14622, "INV_Gauntlets_28", "=q2=Deathbone Gauntlets", "=ds=#s9#, #a4#", "0.45%" },
		--Changed in 1.10 { 14636, "INV_Belt_16", "=q3=Cadaverous Belt", "=ds=#s10#, #a2#", "0.60%" },
		{ 14636, "INV_Belt_16", "=q2=Cadaverous Belt", "=ds=#s10#, #a2#", "0.60%" },
		--Changed in 1.10 { 14614, "INV_Belt_23", "=q3=Bloodmail Belt", "=ds=#s10#, #a3#", "0.60%" },
		{ 14614, "INV_Belt_23", "=q2=Bloodmail Belt", "=ds=#s10#, #a3#", "0.60%" },
		--Changed in 1.10 { 14620, "INV_Belt_12", "=q3=Deathbone Girdle", "=ds=#s10#, #a4#", "0.67%" },
		{ 14620, "INV_Belt_12", "=q2=Deathbone Girdle", "=ds=#s10#, #a4#", "0.67%" },
		--Changed in 1.10 { 14632, "INV_Pants_08", "=q3=Necropile Leggings", "=ds=#s11#, #a1#", "0.85%" },
		{ 14632, "INV_Pants_08", "=q2=Necropile Leggings", "=ds=#s11#, #a1#", "0.85%" },
		--Changed in 1.10 { 14638, "INV_Pants_07", "=q3=Cadaverous Leggings", "=ds=#s11#, #a2#", "1.09%" },
		{ 14638, "INV_Pants_07", "=q2=Cadaverous Leggings", "=ds=#s11#, #a2#", "1.09%" },
		--Added in 1.4 { 18682, "INV_Pants_02", "=q3=Ghoul Skin Leggings", "=ds=#s11#, #a2#", "1.00%" },
		--Changed in 1.10 { 14612, "INV_Pants_06", "=q3=Bloodmail Legguards", "=ds=#s11#, #a3#", "0.42%" },
		{ 14612, "INV_Pants_06", "=q2=Bloodmail Legguards", "=ds=#s11#, #a3#", "0.42%" },
		--Changed in 1.10 { 14623, "INV_Pants_04", "=q3=Deathbone Legguards", "=ds=#s11#, #a4#", "1.12%" },
		{ 14623, "INV_Pants_04", "=q2=Deathbone Legguards", "=ds=#s11#, #a4#", "1.12%" },
		--Changed in 1.10 { 14631, "INV_Boots_05", "=q3=Necropile Boots", "=ds=#s12#, #a1#", "0.88%" },
		{ 14631, "INV_Boots_05", "=q2=Necropile Boots", "=ds=#s12#, #a1#", "0.88%" },
		--Changed in 1.10 { 14641, "INV_Boots_05", "=q3=Cadaverous Walkers", "=ds=#s12#, #a2#", "0.67%" },
		{ 14641, "INV_Boots_05", "=q2=Cadaverous Walkers", "=ds=#s12#, #a2#", "0.67%" },
		--Changed in 1.10 { 14616, "INV_Boots_01", "=q3=Bloodmail Boots", "=ds=#s12#, #a3#", "0.36%" },
		{ 14616, "INV_Boots_01", "=q2=Bloodmail Boots", "=ds=#s12#, #a3#", "0.36%" },
		--Changed in 1.10 { 14621, "INV_Boots_01", "=q3=Deathbone Sabatons", "=ds=#s12#, #a4#", "0.57%" },
		{ 14621, "INV_Boots_01", "=q2=Deathbone Sabatons", "=ds=#s12#, #a4#", "0.57%" },
		--Added in 1.4 { 18684, "INV_Jewelry_Ring_15", "=q3=Dimly Opalescent Ring", "=ds=#s13# =q2=#e24#", "0.85%" },
		--Added in 1.11 { 23201, "INV_Relics_LibramofHope", "=q3=Libram of Divinity", "=ds=#s16#, #e18# =q16=#c4#", "1.76%" },
		--Added in 1.11 { 23200, "INV_Relics_TotemofLife", "=q3=Totem of Sustaining", "=ds=#s16#, #e17# =q15=#c7#", "1.76%" },
		--Added in 1.4 { 18680, "INV_Weapon_Bow_08", "=q3=Ancient Bone Bow", "=ds=#w2#", "0.91%" },
		--Added in 1.4 { 18683, "INV_Hammer_13", "=q3=Hammer of the Vesper", "=ds=#h1#, #w6#", "1.39%" },
	};
	SCHOLODoctorTheolenKrastinov = {
	...
	SCHOLODarkmasterGandling = {
		...
		--Added in 1.10 { 22433, "INV_Jewelry_Ring_16", "=q3=Don Mauricio's Band of Domination", "=ds=#s13#", "7.72%" },
		...
		{ 0, "", "", "", "" },
		--Added in 1.6 { 19276, "INV_Misc_Ticket_Tarot_Portal_01", "=q3=Ace of Portals", "=ds=#e19#", "2.20%" },
		--{ 0, "", "", "", "" },
	...
	SCHOLOTrash = {
		...
		{ 12840,"INV_Jewelry_Talisman_14","=q1=Minion's Scourgestone","=ds=#m27#" },
		{ 0,"","","" },
		--Added in 1.8 { 20520,"Spell_Shadow_SealOfKings","=q2=Dark Rune","=ds=#m25#, #m26#, #e12#", "16.78%" },
		--Changed in 1.9 { 12753,"INV_Misc_ShadowEgg","=q2=Skin of Shadow","=ds=#m26#", "17.31%" },
		{ 12753,"INV_Misc_ShadowEgg","=q1=Skin of Shadow","=ds=#m26#", "17.31%" },
		{ 0,"","","" },
		{ 0,"","","" },
		--Added in 1.4 { 18698, "INV_Helmet_41", "=q3=Tattered Leather Hood", "=ds=#s1#, #a2#", "0.01%" },
		--Added in 1.4 { 18699, "INV_Shoulder_27", "=q3=Icy Tomb Spaulders", "=ds=#s3#, #a2#", "0.01%" },
		{ 14536, "INV_Chest_Chain_14", "=q3=Bonebrace Hauberk", "=ds=#s5#, #a3#", "0.01%" },
		--Added in 1.4 { 18700, "INV_Bracer_07", "=q3=Malefic Bracers", "=ds=#s8#, #a2#", "0.01%" },
		--Added in 1.4 { 18702, "INV_Belt_28", "=q3=Belt of the Ordained", "=ds=#s10#, #a4#", "0.01%" },
		--Added in 1.4 { 18697, "INV_Boots_Fabric_01", "=q3=Coldstone Slippers", "=ds=#s12#, #a1#", "0.01%" },
		--Added in 1.4 { 18701, "INV_Jewelry_Ring_24", "=q3=Innervating Band", "=ds=#s13#", "0.01%" },
		{ 0,"","","" },
		--Changed in 1.5 { 16254, "INV_Misc_Note_01", "=q3=Formula: Enchant Weapon - Lifestealing", "=ds=#p4# (300) =q7=#x70#", "0.93%" },
		{ 16254, "INV_Misc_Note_01", "=q2=Formula: Enchant Weapon - Lifestealing", "=ds=#p4# (300) =q7=#x70#", "0.93%" },
